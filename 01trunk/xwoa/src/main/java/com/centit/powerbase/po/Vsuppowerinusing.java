...
public class Vsuppowerinusing implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
    private VsuppowerinusingId cid;
    ...
    // Constructors
    /** default constructor */
    public Vsuppowerinusing() {
    }

    /** minimal constructor */
    public Vsuppowerinusing(VsuppowerinusingId id
    ...
    public VsuppowerinusingId getCid() {
        return this.cid;
    }

    public void setCid(VsuppowerinusingId id) {
        this.cid = id;
    }

    public String getItemId() {
        if (this.cid == null)
            this.cid = new VsuppowerinusingId();
    ...
    public void copy(Vsuppowerinusing other) {
    ...
    public void copyNotNullProperty(Vsuppowerinusing other) {
