...
public class VsuppowerwithoutlobId implements java.io.Serializable {
	...
	// Constructors
	/** default constructor */
	public VsuppowerwithoutlobId() {
	}
	/** full constructor */
	public VsuppowerwithoutlobId(String itemId, Long version) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VsuppowerwithoutlobId))
			return false;
		
		VsuppowerwithoutlobId castOther = (VsuppowerwithoutlobId) other;
		boolean ret = true;
