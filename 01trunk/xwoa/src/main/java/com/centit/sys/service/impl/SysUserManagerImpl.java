...
public class SysUserManagerImpl extends BaseEntityManagerImpl<FUserinfo> implements
    ...
    public FUserinfo getFUserInfoByLoginname(String loginName){
        return sysuserdao.getFUserInfoByLoginname(loginName);
    }
...
*/
    ...
    public void saveUserrole(FUserrole userrole) {
        ...
        FUserinfo tt = new FUserinfo();
        tt.setUserkind("2");
        sysuserdao.saveObject(tt);
        userRoleDao.saveObject(userrole);
    }
    ...
    @Override
    public List<FUserinfo> listnew(Map<String, Object> filterMap, PageDesc pageDesc) {
        return sysuserdao.listObjects(filterMap,pageDesc);
    }
    ...
    /*@Override
    public List<FUserinfo> getUserByTJ() {
        return sysuserdao.getUserByTJ();
    }*/
