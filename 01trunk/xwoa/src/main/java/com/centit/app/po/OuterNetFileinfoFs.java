...
public class OuterNetFileinfoFs implements java.io.Serializable {
    ...
    public File getFile() {
        String path = FilenameUtils.normalize(SysParametersUtils.getUploadHome() + this.getPath());
	...
	public void copy(OuterNetFileinfoFs other){
	...
	public void copyNotNullProperty(OuterNetFileinfoFs other){
	...
	public OuterNetFileinfoFs() {
		super();
	}

	public OuterNetFileinfoFs(String filecode) {
		super();
		this.filecode = filecode;
	}
