...
public interface OuterNetFileinfoFsManager extends BaseEntityManager<OuterNetFileinfoFs> 
{
     ...
     * @throws IOException
     */
    public OuterNetFileinfoFs saveFileinfo(OuterNetFileinfoFs file, InputStream is, String optID) throws IOException;
     ...
     */
    @Deprecated
    public boolean deleteFileinfo(OuterNetFileinfoFs file);
     ...
     * @return
     */
    public boolean deleteFileOnDisk(OuterNetFileinfoFs file);
     ...
     * @return
     */
    public InputStream downloadFileinfo(OuterNetFileinfoFs file) throws IOException;
