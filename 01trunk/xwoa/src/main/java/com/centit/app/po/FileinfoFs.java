...
public class FileinfoFs implements java.io.Serializable {
	...
	public void copy(FileinfoFs other){
	...
	public void copyNotNullProperty(FileinfoFs other){
	...
	public FileinfoFs(String filecode) {
		super();
		this.filecode = filecode;
	}
