...
public class AddressBookFs implements java.io.Serializable {
...
/** full constructor */
	...
	public void copy(AddressBookFs other){
	...
	public void copyNotNullProperty(AddressBookFs other){
