...
public class VStuffTransaffairDao extends BaseDaoImpl<VStuffTransaffair> {
    private static final long serialVersionUID = 1L;
    public static final Log log = LogFactory.getLog(VStuffTransaffairDao.class);
    ...
    public Map<String, String> getFilterField() {
        if (filterField == null) {
            ...
            filterField.put("solvestatus", CodeBook.EQUAL_HQL_ID);
            ...
            filterField.put("subItemType", CodeBook.EQUAL_HQL_ID);
