...
public class DispatchDocTask implements java.io.Serializable {
	...
	public DispatchDocTask(Long taskId, Long nodeInstId, String unitCode,
...
/** full constructor */
	...
	public void copy(DispatchDocTask other){
	...
	public void copyNotNullProperty(DispatchDocTask other){
