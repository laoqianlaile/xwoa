...
public class VDispatchDocListDao extends BaseDaoImpl<VDispatchDocList> {
    ...
    public List<VDispatchDocList> listDispatchDoc(
        ...
        String orderBy="order by createdate desc,dispatch_date desc";//排序
        ...
        String hql1 = "select distinct no,'1' as usercode,item_id,dispatch_doc_no,dispatch_doc_title," +
                ...
                "solvenote,createdate,sendarchiveno,acceptarchiveno,dispatch_user,nodename,bizusernames,warntype,'1' as unitcode,'1' as username,DISPATCH_DATE " + hql.getHql() + queryUsercode+orderBy;
