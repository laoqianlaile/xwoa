...
public class CommonDocTask implements java.io.Serializable{
...
/** full constructor */
    public CommonDocTask(
     Long taskId        
    ,Long  nodeInstId,String  unitCode,String  userCode,String  roleType,String  roleCode,String  optId,Long  flowInstId,String  flowOptName,String  flowOptTag,String  authDesc,String  nodeName,String  nodeType,String  nodeOptType,String  optName,String  methodName,String  optUrl,String  optMethod,String  optDesc,String  optCode,String  optParam,String  inststate,Date  nodeCreateTime,Long  expireOptSign,String  expireOpt,String  grantor,Long  timeLimit,String  lastUpdateUser,Date  lastUpdateTime,String  flowPhase,String  djId,String  transaffairname,String  bizstate,String  biztype,String  orgcode,String  orgname,String  headunitcode,String  headusercode,String  content,String  powerid,String  powername,String  solvestatus,Date  solvetime,String  solvenote,String  createuser,Date  createdate,String  riskType,String  sendArchiveNo,String  acceptArchiveNo,String  riskDesc,String  riskResult,String  transAffairNo,String  transAffairQueryKey) {
    ...
    public CommonDocTask(Long taskId, Long nodeInstId, String unitCode,
        ...
        Date lastUpdateTime, String flowPhase, String djId,
        String transaffairname, String bizstate, String biztype,
        String orgcode, String orgname, String headunitcode,
        String headusercode, String content, String powerid, String powername,
        String solvestatus, Date solvetime, String solvenote,
        String createuser, Date createdate, String riskType,
        String sendArchiveNo, String acceptArchiveNo, String riskDesc,
        String riskResult, String transAffairNo, String transAffairQueryKey,
        String nodeCode, String flowCode) {
    super();
    this.taskId = taskId;
    this.nodeInstId = nodeInstId;
    this.unitCode = unitCode;
    ...
    public void copy(CommonDocTask other){
    ...
    public void copyNotNullProperty(CommonDocTask other){
    ...
    public String getNodeOptUrl() {
        ...
        String url = optDesc.getOptUrl() +
                "?nodeInstId="+getNodeInstId()+"&flowInstId="+flowInstId+"&flowPhase="+ flowPhase+"&nodeCode="+ nodeCode;
