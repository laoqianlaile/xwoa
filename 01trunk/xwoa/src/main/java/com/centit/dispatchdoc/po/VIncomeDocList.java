...
public class VIncomeDocList implements java.io.Serializable {
    ...
    private String transcontent;//办公室拟办意见
    // Constructors
    /** default constructor */
    ...
    public VIncomeDocList(String djId, String usercode, String incomeDocNo,
            ...
            String bizusernames,String username,String transcontent) {
        super();
        this.djId = djId;
    ...
    public VIncomeDocList(String djId, String usercode, String incomeDocNo,
            ...
            String solvestatus, Date solvetime, String solvenote,
            Date createdate2, String acceptArchiveNo, String nodename,
            String bizusernames,String belongUnitcode,String username,String transcontent) {
        super();
        this.djId = djId;
        this.usercode = usercode;
        this.incomeDocNo = incomeDocNo;
    ...
    public VIncomeDocList(String djId, String usercode, String incomeDocNo,
            ...
            String orgcode, String orgname, String powerid, String powername,
            String solvestatus, Date solvetime, String solvenote,
            Date createdate, String acceptArchiveNo,String transcontent) {
        super();
        this.djId = djId;
        this.usercode = usercode;
        this.incomeDocNo = incomeDocNo;
    ...
    public VIncomeDocList(String djId, String usercode, String incomeDocNo,
            ...
            String orgcode, String orgname, String powerid, String powername,
            String solvestatus, Date solvetime, String solvenote,
            Date createdate, String acceptArchiveNo,String belongUnitcode,String transcontent) {
        super();
        this.djId = djId;
        this.usercode = usercode;
        this.incomeDocNo = incomeDocNo;
