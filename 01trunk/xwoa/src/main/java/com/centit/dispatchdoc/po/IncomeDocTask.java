...
public class IncomeDocTask implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public IncomeDocTask() {
    }

    /** minimal constructor */
    public IncomeDocTask(Long taskId) {
    ...
    /** full constructor */
    public IncomeDocTask(Long taskId, Long nodeInstId, String unitCode,
            ...
            String transAffairNo, String transAffairQueryKey) {
    ...
    public void copy(IncomeDocTask other) {
    ...
    public void copyNotNullProperty(IncomeDocTask other) {
    ...
    public void setNodeCode(String nodeCode) {
        if (null != nodeCode
                && (0 == nodeCode.indexOf("P_") || 0 == nodeCode.indexOf("N_"))) {
