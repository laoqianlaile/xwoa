...
public class VUserTransaffairDcyj implements java.io.Serializable {
...
/** full constructor */
	...
	public void copy(VUserTransaffairDcyj other){
		...
		this.attUser= other.getAttUser();  
		this.attSetUser= other.getAttSetUser();  
		this.dcyj= other.getDcyj();

	}
	
	public void copyNotNullProperty(VUserTransaffairDcyj other){
