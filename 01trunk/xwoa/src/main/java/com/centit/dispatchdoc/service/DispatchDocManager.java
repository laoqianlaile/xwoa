...
import com.centit.dispatchdoc.dao.OaLeaderSortDao;
...
public interface DispatchDocManager extends BaseEntityManager<DispatchDoc> 
{
    ...
    //收文流程 分管领导 排序
    void saveOaLeaderSort(Oaleadersort oaleadersort);

    List<Oaleadersort> listOaLeaderSortByNode(Long nodeInstId);

    List<Oaleadersort> listOaLeaderSortByUserCode(String userCode);
