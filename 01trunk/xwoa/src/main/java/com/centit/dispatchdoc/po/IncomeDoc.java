...
public class IncomeDoc implements java.io.Serializable {
    ...
    private String acceptArchiveNumber; // 编号
    
    private String incomeDateStr;//来文日期，值给PDF展示使用
    ...
    public IncomeDoc(String djId, String internalNo, String itemId,
            ...
            Date caseAcceptDate, Date signIssueDate,String remark) {
    ...
    public IncomeDoc(String djId, String internalNo, String itemId,
            ...
            String incomeDocType, Date toBeanfinishedDate,String remark) {
        super();
        this.djId = djId;
        this.internalNo = internalNo;
        this.itemId = itemId;
    ...
    public IncomeDoc(String djId, String internalNo, String itemId,
            ...
            Date createDate, Date updateDate, Date syncDate, String syncSign,
            Date caseAcceptDate, Date signIssueDate, String criticalLevel,
            String incomeDocType,String remark) {
        super();
        this.djId = djId;
        this.internalNo = internalNo;
        this.itemId = itemId;
    ...
    public String getAcceptArchiveNumber() {
        return acceptArchiveNumber;
    }

    public void setAcceptArchiveNumber(String acceptArchiveNumber) {
        this.acceptArchiveNumber = acceptArchiveNumber;
    }
    
    public String getIncomeDateStr() {
        if(incomeDate!=null){
            DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
            return df.format(incomeDate);
        }else{
    ...
    public void setIncomeDateStr(String incomeDateStr) {
        this.incomeDateStr = incomeDateStr;
    }
}
