...
public class OaNetapplicationAction  extends OACommonBizAction<OaNetapplication>  {
	private static final Log log = LogFactory.getLog(OaNetapplicationAction.class);
	private static final long serialVersionUID = 1L;
	private OaNetapplicationManager oaNetapplicationMag;
	public void setOaNetapplicationManager(OaNetapplicationManager basemgr)
	{
		oaNetapplicationMag = basemgr;
		this.setBaseEntityManager(oaNetapplicationMag);
	}
     ...
     public String list() {
         ...
         objList = oaNetapplicationMag.listObjects(filterMap, pageDesc);
     ...
     public String edit() {
         ...
         if (StringUtils.isBlank(object.getDjId())) {
             object.setDjId(optApplyManager.getNextDjId("SQ","oaNetapplication"));
         }
    ...
    //                  否则  只保留上下文 /oa_szgh
     ...
     public String savePermitReg() {
         try {
             ...
             // 申请state=6标记为暂存
             oaNetapplicationMag.saveObject(object);

             object = oaNetapplicationMag.getObjectById(object.getDjId());
     ...
     public String saveAndSubmit() {
         ...
         // 保存
         FUserDetail fuser = ((FUserDetail) getLoginUser());
         OaNetapplication oaNetapplication = oaNetapplicationMag
                 .getObjectById(object.getDjId());
         if (oaNetapplication != null) {
             oaNetapplicationMag.copyObject(oaNetapplication, object);
             object = oaNetapplication;
         }
         object.setCreater(fuser.getUsercode());
         ...
         if (object != null) {
             ...
             flowEngine.assignFlowOrganize(optBaseInfo.getFlowInstId(), "DJBM",
                     fuser.getPrimaryUnit(), "公示公告入网申请登记");
             ...
             this.saveIdeaInfo("公示公告入网申请登记", 0L);
         }
          ...
          if("true".equals(SysParametersUtils.getParameters("generatePdfForDocEnable", "false"))){
            ...
            //"***/anonymous***"代表匿名访问
              ...
              taskExecutor.execute(new Runnable(){
                  @Override
                  public void run() {
                      optPdfInfoManager.createPDF(object.getDjId(), "入网申请", 0L,userCode,exePath,formHtmlUrl);
                  }
              });
          }
      }
     ...
     public String delete() {
         if (StringUtils.isNotBlank(object.getDjId())) {
             ...
             oaNetapplicationMag.deleteObjectById(object.getDjId());
         }
         return "nextList";
     }
     ...
     public String saveReditSQ() {
         OaNetapplication oaNetapplication = oaNetapplicationMag
                 .getObjectById(object.getDjId());
         if (oaNetapplication != null) {
             oaNetapplicationMag.copyObjectNotNullProperty(
                     oaNetapplication, object);
             object = oaNetapplication;
         }
         oaNetapplicationMag.saveObject(object);
