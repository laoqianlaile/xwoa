...
public class OaBuffetapplyDao extends BaseDaoImpl<OaBuffetapply>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(OaBuffetapplyDao.class);
	...
	public Map<String, String> getFilterField() {
		if( filterField == null){
			...
			filterField.put("visitorsnum" , CodeBook.LIKE_HQL_ID);
