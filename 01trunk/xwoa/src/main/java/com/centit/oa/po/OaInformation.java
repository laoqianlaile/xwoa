...
public class OaInformation implements java.io.Serializable {
...
public OaInformation(String no, String infoType, String title,
            ...
            Date lastmodifytime, String creater, Date creatertime, String state,String isAllowComment) {
        super();
        this.no = no;
...
public OaInformation(String no, String infoType, String title,
        ...
        String publicKey, String docNo, String author,
        String uploadFileName, String referenceLinks, String remark,
        Date lastmodifytime, String creater, Date creatertime, String state,String isAllowComment,String readstate) {
    super();
    this.no = no;
    this.infoType = infoType;
    this.title = title;
...
/** full constructor */
	...
	public OaInformation(
	        String no      
	       ,String  infoType,String  title,String  majorDegree,Date  releaseDate,Date  validDate,String  publicKey,String  docNo,String  author,byte[]  uploadFile,String  uploadFileName,String  referenceLinks,String  bodyContent,String  remark,Date  lastmodifytime,String  creater,Date  creatertime,String  state,String depno,String isAllowComment,String imagePath,String readstate) {
...
public void setIsAllowComment(String isAllowComment) {
    ...
    public void copy(OaInformation other){
	...
	public void copyNotNullProperty(OaInformation other){
