...
public class Msgannex implements java.io.Serializable {
    ...
    public FileinfoFs getFileinfo() {
        return fileinfo;
    }

    public void setFileinfo(FileinfoFs fileinfo) {
        this.fileinfo = fileinfo;
    }

    private String msgannexId;
    private Innermsg innermsg;
    private FileinfoFs fileinfo;


    public Msgannex() {
    }

    public Msgannex(String msgannexId, Innermsg innermsg, FileinfoFs fileinfo) {
        this.msgannexId = msgannexId;
        this.innermsg = innermsg;
        this.fileinfo = fileinfo;
    }

    public Msgannex(Innermsg innermsg, FileinfoFs fileinfo) {
