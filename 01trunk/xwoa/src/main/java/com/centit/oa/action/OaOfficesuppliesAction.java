...
public class OaOfficesuppliesAction  extends OACommonBizAction<OaOfficesupplies>  {
	private static final Log log = LogFactory.getLog(OaOfficesuppliesAction.class);
	private static final long serialVersionUID = 1L;
	private OaOfficesuppliesManager oaOfficesuppliesMag;
	public void setOaOfficesuppliesManager(OaOfficesuppliesManager basemgr)
	{
		oaOfficesuppliesMag = basemgr;
		this.setBaseEntityManager(oaOfficesuppliesMag);
	}
     ...
     public String list() {
         ...
         objList = oaOfficesuppliesMag.listObjects(filterMap, pageDesc);
     ...
     public String edit() {
         ...
         if (StringUtils.isBlank(object.getDjId())) {
             object.setDjId(optApplyManager.getNextDjId("SQ","oaOfficesupplies"));
         }
         ...
         if(StringUtils.isBlank(object.getLayoutno())){
             object.setLayoutno(oaOfficesuppliesMag.getNextKeyMax());
         }
       //流程内编辑准备itemId
         if(null==itemId){
    ...
    //                  否则  只保留上下文 /oa_szgh
     ...
     public String savePermitReg() {
         try {
             ...
             // 申请state=6标记为暂存
             oaOfficesuppliesMag.saveObject(object);

             object = oaOfficesuppliesMag.getObjectById(object.getDjId());
     ...
     public String saveAndSubmit() {
         ...
         // 保存
         FUserDetail fuser = ((FUserDetail) getLoginUser());
         OaOfficesupplies oaOfficesupplies = oaOfficesuppliesMag
                 .getObjectById(object.getDjId());
         if (oaOfficesupplies != null) {
             oaOfficesuppliesMag.copyObject(oaOfficesupplies, object);
             object = oaOfficesupplies;
         }
         object.setCreater(fuser.getUsercode());
          ...
          if("true".equals(SysParametersUtils.getParameters("generatePdfForDocEnable", "false"))){
            ...
            //"***/anonymous***"代表匿名访问
              ...
              taskExecutor.execute(new Runnable(){
                  @Override
                  public void run() {
                      optPdfInfoManager.createPDF(object.getDjId(), "物品申领", 0L,userCode,exePath,formHtmlUrl);
                  }
              });
          }
      }
     ...
     public String delete() {
         if (StringUtils.isNotBlank(object.getDjId())) {
             ...
             oaOfficesuppliesMag.deleteObjectById(object.getDjId());
         }
         return "nextList";
     }
     ...
     public String saveReditSQ() {
         OaOfficesupplies oaOfficesupplies = oaOfficesuppliesMag
                 .getObjectById(object.getDjId());
         if (oaOfficesupplies != null) {
             oaOfficesuppliesMag.copyObjectNotNullProperty(
                     oaOfficesupplies, object);
             object = oaOfficesupplies;
         }
         oaOfficesuppliesMag.saveObject(object);
