...
public class OaDuescollectioninfosId implements java.io.Serializable {
	...
	// Constructors
	/** default constructor */
	public OaDuescollectioninfosId() {
	}
	/** full constructor */
	public OaDuescollectioninfosId(String djId, String usercode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OaDuescollectioninfosId))
			return false;
		
		OaDuescollectioninfosId castOther = (OaDuescollectioninfosId) other;
		boolean ret = true;
