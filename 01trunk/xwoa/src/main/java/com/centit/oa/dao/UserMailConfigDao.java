...
public class UserMailConfigDao extends BaseDaoImpl<UserMailConfig> {
    ...
    public List<UserMailConfig> getUsrmailfonfigsByCodeAndAccount(String usercode,String emailaccount){
        List<UserMailConfig> list=getHibernateTemplate().find("from UserMailConfig where usercode=? and mailaccount=? ",new Object[]{usercode,emailaccount});
        return list;
    }
}
