...
public class OaLeavereportedDao extends BaseDaoImpl<OaLeavereported>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(OaLeavereportedDao.class);
	...
	public Map<String, String> getFilterField() {
		if( filterField == null){
			...
			filterField.put("leaveaddress" , CodeBook.LIKE_HQL_ID);
