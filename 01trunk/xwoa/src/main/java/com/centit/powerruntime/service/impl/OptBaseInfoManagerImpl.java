...
public class OptBaseInfoManagerImpl extends BaseEntityManagerImpl<OptBaseInfo>
    ...
    public List<OptBaseInfo> listOptBaseInfo(String acceptArchiveNo,
            String powerid) {
        return optBaseInfoDao.listOptBaseInfoModify(acceptArchiveNo, powerid);
    }
    ...
    */
     ...
     */
     @Override
     public Long getPreviousNode(Long curNodeInstId) {
         String hql=" select t.prevnodeinstid from WF_NODE_INSTANCE t "
                  + " where  t.nodeinstid="+curNodeInstId;
         Long  previousNode = null;
         List<Object>  l = ((List<Object>) optBaseInfoDao.findObjectsBySql(hql.toString()));  
         if(null != l.get(0)){
             previousNode=Long.valueOf(l.get(0).toString());
         }
         return previousNode;
     }
    ...
    public VsuppowerinusingDao getVsuppowerinusingDao() {
        return vsuppowerinusingDao;
    }
    ...
    public List<Object[]> listoptBaseExceptionNum() {
        return optBaseInfoDao.listoptBaseExceptionNum();
    }

    @Override
    public List<Object[]> listoptBaseNumByYear() {
        return optBaseInfoDao.listoptBaseNumByYear();
    }
