...
public class OptBaseInfo implements java.io.Serializable {
    ...
    private Date flowSuperviseDate;//督办时限
    private String flowSuperviseIdea;//批示意见
    ...
    public OptBaseInfo(String djId, String optId, String flowCode,
            ...
            String isUpload, Date toBeanfinishedDate,String gwNature) {
    ...
    public void copy(OptBaseInfo other) {
        ...
        this.flowSupervise=other.getFlowSupervise();
        this.flowSuperviseDate=other.getFlowSuperviseDate();
        this.flowSuperviseIdea=other.getFlowSuperviseIdea();
    }
    ...
    public void copyNotNullProperty(OptBaseInfo other) {
        ...
        if(other.getFlowSupervise()!=null)
            this.flowSupervise=other.getFlowSupervise();
        if(other.getFlowSuperviseDate()!=null)
            this.flowSuperviseDate=other.getFlowSuperviseDate();
        if(other.getFlowSuperviseIdea()!=null)
            this.flowSuperviseIdea=other.getFlowSuperviseIdea();
    ...
    public void clearProperties() {
        ...
        this.flowSupervise=null;
        this.flowSuperviseDate=null;
        this.flowSuperviseIdea=null;
    }
    ...
    public Date getFlowSuperviseDate() {
        return flowSuperviseDate;
    }

    public void setFlowSuperviseDate(Date flowSuperviseDate) {
        this.flowSuperviseDate = flowSuperviseDate;
    }

    public String getFlowSuperviseIdea() {
        return flowSuperviseIdea;
    }

    public void setFlowSuperviseIdea(String flowSuperviseIdea) {
        this.flowSuperviseIdea = flowSuperviseIdea;
    }
