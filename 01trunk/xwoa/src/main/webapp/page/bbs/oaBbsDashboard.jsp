								...
								<td class="showTimeTd"><c:if
									...
									<c:choose>
										<c:when test="${not empty discussions.showpicturename }">
											<img
												src='${contextPath }/bbs/oaBbsDiscussion!showImage.do?layoutno=${discussions.layoutno}' style="width: 130px; height: 100px"/>
										</c:when>
										<c:otherwise>
											<img src='${ctx}/themes/blue/images/img.png' style="width: 130px; height: 100px"/>
										</c:otherwise>
									</c:choose> <span> <br><a class="showTime"
										...
										</c:if> <br><br> 主题：${empty discussions.subjectnum ? 0 :
