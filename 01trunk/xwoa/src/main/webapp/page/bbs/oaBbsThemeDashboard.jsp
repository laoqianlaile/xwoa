...
<link href="${pageContext.request.contextPath}/themes/css/arrow.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/styles/default/css/oabbs/bbs.css"
	rel="stylesheet" type="text/css" />
...
.submit-botton {
/* 	background: url(${contextPath}/styles/default/css/oaInformationimage/XWsearch.png) center center no-repeat;
	border: currentColor;
	border-image: none;
...
<body>
	...
	<form id="form1"
		...
		<div class="top">
			今日主题数：<span>${todayThemeNum}</span><span
				style="margin: 0px 5px 0px 5px">|</span>板块主题数：<span>${empty
