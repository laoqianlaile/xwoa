		...
		<section class="public-position" id="publicPosition" >
			...
			<div class="pubpos-search-box" style="float: right;">
				...
				<s:form action="oaInformation" method="post" namespace="/oa"
					...
					<input name="s_searchword" class="search-txt" id="txt_searchWord_nav" type="text" size="100" placeholder="请输入关键词">
			...
			<c:if test="${(cp:CHECKUSEROPTPOWER('NEWS_GGZY', 'edit') and infoType eq 'news')
						...
						or (cp:CHECKUSEROPTPOWER('INFO_ACT', 'edit') and infoType eq 'activity')
						or (cp:CHECKUSEROPTPOWER('1_ZBAP', 'edit') and infoType eq 'ZWoncall')
						or (cp:CHECKUSEROPTPOWER('2_ZBAP', 'edit') and infoType eq 'YJoncall')
						or (cp:CHECKUSEROPTPOWER('3_ZBAP', 'edit') and infoType eq 'RConcall')
			}">
