		...
		<legend>办公资源查询</legend>		
			<table cellpadding="0" cellspacing="0" align="left">
				<tr>
					...
					<td width="180">
					<select id="s_equipmentState" name="s_equipmentState" style="width: 100px;" data-value="${s_equipmentState}">
											<option value=""></option>
					...
					<td>
					<s:submit method="applicantDetailList" key="opt.btn.query" cssClass="btn" />
<!-- 					<input type="submit" class="btn"  data-form="#equipmentInfoForm" value="查询"/> -->
					<s:submit method="applicantList" key="opt.btn.query" cssClass="btn" value="返回" />
<!--  					<input type="button" class="btn"   -->
<!-- 							target="submit"  -->
<!-- 							data-form="#equipmentInfoForm"  -->
<%-- 							data-href="${pageContext.request.contextPath}/oa/equipmentInfo!applicantList.do" value="返回">  --%>
					</td>
				</tr>
			</table>
			</fieldset>
