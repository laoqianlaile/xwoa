			 ...
			 外出请假报备单
      		...
      		<table cellpadding="0" cellspacing="0" style="width:100%;border:1px #e8e8e8 solid; border-collapse:collapse;font-size:14px;font-family: Microsoft YaHei;text-align:left;table-layout: fixed;">
				 ...
				 <tr>
					...
					<td style="border:1px #e8e8e8 solid;padding-left:10px;width:40%;"></td>
					<td style="border:1px #e8e8e8 solid;text-align:center;height:40px;font-weight: bold;width:130px;">				
						日期	
					</td>
				...
				<tr>
					<td style="border:1px #e8e8e8 solid;text-align:center;height:60px;font-weight: bold;width:130px;">				
						备注		
					</td>
					<td style="border:1px #e8e8e8 solid;padding-left:10px;" colspan="3">
						${remark}
...
function openEdit() {
	url="${pageContext.request.contextPath}/oa/oaLeavereported!editOptBaseSQ.do?djId=${djId}&random=" + Math.random();
	art.dialog
	.open(url,
