			...
			耗材配件购置信息
      		...
      		<table cellpadding="0" cellspacing="0" style="width:100%;border:1px #e8e8e8 solid; border-collapse:collapse;font-size:14px;font-family: Microsoft YaHei;text-align:left;table-layout: fixed;">
				 ...
				 <tr>
					...
					<td style="border:1px #e8e8e8 solid;padding-left:10px;width:130px;" >
						${cp:MAPVALUE('unitcode', object.unitcode)}
					</td>
...
function openEdit() {
	url="${pageContext.request.contextPath}/oa/oaConsumablesParts!editOptBaseSQ.do?djId=${djId}&random=" + Math.random();
	art.dialog
	.open(url,
