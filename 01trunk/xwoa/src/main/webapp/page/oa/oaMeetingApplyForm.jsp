...
<body  class="sub-flow">
		...
		<s:form action="oaMeetingApply" method="post" namespace="/oa"
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				<tr>
					...
					<td align="left" colspan="3"><s:textfield name="meetApplyName"
				...
				<tr>
					...
					<td align="left"><s:textarea name="meetApplyAddress"
					...
					<td align="left"><input type="text" class="Wdate"
						...
						value='<fmt:formatDate value="${object.meetApplytime}" pattern="yyyy-MM-dd"/>'
						name="meetApplytime"
				...
				<%-- <tr>
					...
					<td align="left" colspan="3"><s:textfield name="attendUnitName"
							style="width:100%;height:30px;" /></td>
				</tr>
				
				<tr>
					<td class="addTd" style ="text-align: center;">外来人员</td>
					<td align="left" colspan="3"><s:textfield name="foreigUserName"
							style="width:100%;height:30px;" /></td>
				</tr>
				<tr>
					<td class="addTd" style ="text-align: center;">外来部门</td>
					<td align="left" colspan="3"><s:textfield name="foreigUnitName"
							style="width:100%;height:30px;" /></td>
				</tr> --%>
				<tr>
	...
	function similarity(winUrl, winName, winProps) {
        ...
        var srForm  = document.getElementById("oaMeetingApplyForm");
		srForm.action = 'oaMeetingApply!save.do';
		 $.ajax({
            type: "post",
            url: srForm.action,     
            data:$("#oaMeetingApplyForm").serialize(),
            async: false,
            success: function(data) {
