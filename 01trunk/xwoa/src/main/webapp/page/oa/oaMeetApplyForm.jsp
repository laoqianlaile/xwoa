		...
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
		   ...
		   <tr class="checkMeetType">
			...
			<tr>
				...
				<s:textarea name="attendingLeaderNames" id="attendingLeaderNames" style="width:85%;height:40px;"/>
				<input type="button" class='btn' id="attendingLeader" name="attendingLeader" value="选择"><br>(<span style="color: blue">温馨提示：如果是外单位领导成员请手工输入，人员之间请用“,”隔开;如果没有请填“无”。</span>)
			</tr>
			<tr>
...
function selectPopWin(json, o1, o2, oShow) {
	new treePerson(json, o1, o2, oShow).init();/* 此处人员限制为100人 */
	setAlertStyle("attAlert");
}
</script>
</html>
