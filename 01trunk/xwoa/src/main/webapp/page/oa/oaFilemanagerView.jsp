	...
	<s:form action="oaFilemanager" method="post" namespace="/oa" id="oaFilemanagerForm" enctype="multipart/form-data">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable" >
			...
			<tr>
				...
				<td align="left" colspan="3">${object.title}</td>
			</tr>
            <tr>
				<td class="addTd">关键字 
				</td>
				<td align="left"  colspan="3">${object.publicKey}</td>
			</tr>
			<tr>
				<td class="addTd">发布日期*<font color='red'>*</font>
				</td>
				<td align="left"><fmt:formatDate value="${object.releaseDate}"  pattern="yyyy-MM-dd"/>
			   </td>
				<td class="addTd">文件有效期</td>
				<td align="left"><fmt:formatDate value="${object.validDate}"  pattern="yyyy-MM-dd"/>
			...
			<tr >
				...
				<td align="left" colspan="3" >${object.remark}
				</td>
		...
		<div class="formButton">
				...
				onclick="self.location=document.referrer;" value="返回" />
		</div>
	</s:form>
	</fieldset>
	</body>	
