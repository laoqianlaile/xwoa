		...
		<s:form action="oaSchedule" method="post" namespace="/oa"
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left" style="width: 38%;height:175px;" colspan="3">
					<textarea style="border: 0;width: 100%;height: 100%;resize:none;"  readonly="readonly"><s:property value="%{title}" /></textarea>
					</td>
					<%-- <td class="addTd"><s:text name="oaSchedule.importantTag" /></td>
