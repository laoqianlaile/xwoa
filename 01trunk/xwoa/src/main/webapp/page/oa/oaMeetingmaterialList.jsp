...
<body>
	...
	<ec:table
		action="${pageContext.request.contextPath}/oa/oaMeetingmaterial!list.do"
		items="objList" var="foaMeetingmaterial"
		imagePath="${pageContext.request.contextPath}/themes/css/images/table/*.gif"
		retrieveRowsCallback="limit">
		<ec:row>
			<ec:column property="meetingName" title="议程名称" style="text-align:center" />
			...
			<ec:column property="opt" title="${optlabel}" sortable="false"
				...
				<c:if test="${'F' ne showTag}">
					...
					<a
						href="${pageContext.request.contextPath}/oa/oaMeetingmaterial!view.do?djId=${foaMeetingmaterial.djId}">
						归档展示</a>
					<a
						href="${pageContext.request.contextPath}/oa/oaMeetingmaterial!edit.do?djId=${foaMeetingmaterial.djId}">
						编辑</a>
					<a class="delete" onclick='return confirm("确定要删除吗?");'
						href="${pageContext.request.contextPath}/oa/oaMeetingmaterial!delete.do?djId=${foaMeetingmaterial.djId}&meetingAttendee=${foaMeetingmaterial.meetingAttendeesCodes}">
						删除</a>
				</c:if>
			</ec:column>
		</ec:row>
