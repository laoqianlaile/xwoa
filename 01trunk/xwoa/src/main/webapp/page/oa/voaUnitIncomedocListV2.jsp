		...
		<ec:table action="oa/oaUnitIncomedoc!listDoc.do" items="VoaUnitIncomedocs" var="oaUnitIncomedoc"
			...
			<ec:row>
			   <ec:column property="oaUnitIncomedoc.no"
		        ...
		        <ec:column property="acceptarchiveno"  title="收文号" style="text-align:center" width="8%"/>
				...
				<ec:column property="incomeDeptName" title="发文单位" style="text-align:center" width="12%"/>
				<ec:column property="incomeDocNo" title="发文字号" style="text-align:center" width="8%"/>
				<ec:column property="incomeDate" title="收文日期" style="text-align:center " width="8%">
