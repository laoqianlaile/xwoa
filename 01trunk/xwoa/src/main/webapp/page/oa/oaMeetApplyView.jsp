...
<h3
			...
			${cp:MAPVALUE('SYSPARAM','BizzName')}会议室使用申请单<a id="printBtn" title="打印"onclick="print();" style="background:url('${ctxStatic}/image/print.png') no-repeat;width:16px;height:15px;display:inline-block;cursor:pointer;margin-left:15px;"></a>
			</h3>
		<br />
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td align="left" colspan="3"><p>${oaMeetApply.oaMeetinfo.meetingName}</p></td>
			</tr>
