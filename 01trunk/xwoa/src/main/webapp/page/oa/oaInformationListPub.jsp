...
<body id="body_">
	<div class="tableright" style="left: 0px;position:static;width:98%">
		...
		<section class="public-position" id="publicPosition">
			<div class="pubpos-nav">当前位置：发布的活动</div>			
			...
			<c:forEach items="${vobjList }" var="oaInformation" varStatus='i'>
				<tr style="width: auto;">
					...
					<td style="text-align: right;width:200px;" >					
							<a class="guidang" href='oa/oaInfosummary!list.do?infoNo=${oaInformation.no}'>参与详情</a>
				...
				<tr ${i.count % 1 ==0? ' style="border-bottom: 1px dashed #dedede;"' : ''} style="padding:0" class="odd" onmouseover="this.className='highligh'" onmouseout="this.className='odd'">
					<td></td>
					<c:if test="${oaInformation.isTop eq 'T'}">
