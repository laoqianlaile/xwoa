...
<body class="sub-flow">
	...
	<s:form action="oaSmssend" method="post" namespace="/oa"
		...
		<s:submit name="save" method="saveAcceptpeo" cssClass="btn" key="opt.btn.save" value="发送"/>
		...
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
			...
			<tr>
				...
				<input type="text" id="acceptpeo"
					...
					<input type="hidden" id="acceptpeocode" name="acceptpeocode" value="${object.acceptpeocode}" /></td>
...
<script type="text/javascript">
	...
	function selectUsers() {
				var d = '${userjson}';
				if (d.trim().length) {
					new treePerson(jQuery.parseJSON(d), $("#acceptpeo"),$("#acceptpeocode")).init();
