...
<body>
	...
	<ec:table action="powerbase/vsuppowerinusing!list.do" items="objList"
		...
		<ec:row>
			<ec:column property="itemId" title="事项编号" style="text-align:center" />

			<ec:column property="itemName" title="事项名称" style="text-align:center">
				<c:choose>
			...
			<ec:column property="opt" title="操作" sortable="false"
				style="text-align:center">							
				 ...
				 <c:if test="${suppower.itemType eq 'SW' or  suppower.itemType eq 'FW' or suppower.itemType eq 'QB'}">
