...
<legend><b>事项详细信息</b></legend>
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				<tr>
				<td class="addTd" width="130">事项编码</td>
				<td colspan="3">
				<a
...
<%-- 			    value="%{object.beginTime}"/> --%>
	  ...
	  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss '})" placeholder="选择日期" style="width:200px;height:30px;">
		       </td>
				</tr>
				<tr align="center">
