...
<html>
	...
	<body>
			...
			<s:form action="supPower" namespace="/powerbase" style="margin-top:0;margin-bottom:5">
				...
				<tr>
					...
					<tr>
						<td></td>
						<td>
							<s:submit method="listSupPowerSH"  key="opt.btn.query" cssClass="btn"/>
						</td>
					</tr>
				</table>
			</s:form>
		...
		<ec:table action="powerbase/supPower!listSupPowerSH.do" items="supppowerqlbgList" var="SupPowerWithoutLob" 
		          imagePath="${pageContext.request.contextPath}/themes/css/images/table/*.gif" retrieveRowsCallback="limit">
			<ec:row>
				<ec:column property="itemId" title="权力编码" style="text-align:center">
				<a href="<%=request.getContextPath()%>/powerbase/suppowerchglog!suppowerQlbgShEdit.do?itemId=${SupPowerWithoutLob.itemId}&version=${SupPowerWithoutLob.version}">${SupPowerWithoutLob.itemId}</a>
				</ec:column>
