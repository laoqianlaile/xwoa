...
<fieldset style="padding:10px;">
	...
	<fieldset style="padding-top:6px;">
			...
			<s:form action="dictionary" theme="simple" id="userDefForm">			
				<table cellpadding="0" cellspacing="0" >
					<tr>
						<td width="300" align="left">用户名：<s:textfield name="s_username" value="%{#parameters['s_username']}" />	
						</td>
						...
						<td width="300" align="left">
							岗位角色：
                		<select name="s_userstation" style="width:140px;">
                		<option value="">--请选择--</option>
                    	<c:forEach var="row" items="${cp:LVB('StationType')}">
                        <option value="<c:out value='${row.value}'/>"
                                <c:if test="${row.value==param.s_userstation}">selected="selected"</c:if>>
	...
	<ec:table items="userUnits_rank" var="fUserunit"  action="dictionary!listUserUnits.do?datacode=${datacode }" sortable="false" 
