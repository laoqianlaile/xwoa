	...
	<table cellpadding="0" cellspacing="0" >
		...
		<tr>
			...
			<td colspan="5">
			 ...
			 <input type="button" value="添加用户角色" class="btn btnWide" onclick="location.href='deptManager!bulitUserRole.do?userrole.usercode=${usercode}&underUnit=T'" />
			...
			<input type="button" value="返回" class="btn" onclick="location.href='userDef!listUserInfo.do?s_queryUnderUnit=true&ec_p=${param.ec_p}&ec_crd=${param.ec_crd}'">					
			</td>			
		</tr>
	</table>
     ...
     <ec:table items="userunits" var="fUserunit"  action="userDef!view.do?usercode=${usercode}" sortable="false" showPagination="false"
		...
		<ec:row>
			...
			<ec:column property="unitopt" title="操作" sortable="false"	 >
				...
				<a href='userDef!editUnderUserUnit.do?userUnit.usercode=${usercode}&userUnit.unitcode=${fUserunit.unitcode}&userUnit.userstation=${fUserunit.userstation}&userUnit.userrank=${fUserunit.userrank}&underUnit=T'>
					编辑
				</a>
				<a href='userDef!deleteUnderUserUnit.do?userUnit.usercode=${usercode}&usercode=${usercode}&userUnit.unitcode=${fUserunit.unitcode}&userUnit.userstation=${fUserunit.userstation}&userUnit.userrank=${fUserunit.userrank}&underUnit=T'
			...
			<ec:row>
				...
				<ec:column property="roleopt" title="操作" sortable="false"	 >
					...
					<c:if test="${role.obtaindate lt myDate and ( role.secededate == null or role.secededate gt myDate)}">
						<a href='userDef!deleteUserRole.do?userrole.usercode=${usercode}&usercode=${usercode}&userrole.rolecode=${role.rolecode}&obtaindate=${role.obtaindate}&underUnit=T'
