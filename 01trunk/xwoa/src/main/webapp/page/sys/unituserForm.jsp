...
<s:form action="unit" name="/sys" >
    ...
    <table cellpadding="0" cellspacing="0" class="viewTable">
        ...
        <tr>
            ...
            <td align="left">
                <s:textfield name="userunit.unitcode" value="%{userunit.unitcode}" readonly="true" style="height:30px;width:340px;"/>
            </td>
         </tr>
         <tr>
            <td class="addTd">
        ...
        <tr>
            ...
            <td align="left">
                <s:textfield name="userunit.usercode" onclick="selectUser(this)" id="userCode"  style="height:30px;width:340px;"/>
            </td>
         </tr>
         <tr>
            <td class="addTd">
        ...
        <tr>
            ...
            <td align="left">
                <select name="userunit.userstation" style="width:340px;height: 35px">
         ...
         <tr>
            ...
            <td align="left">
                <select name="userunit.userrank" style="width:340px;height: 35px">
