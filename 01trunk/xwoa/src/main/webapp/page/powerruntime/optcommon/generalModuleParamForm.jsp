...
<%-- <tr>
			...
			<tr>
				...
				<td align="left" colspan="3">			
					...
					<c:if test="${object.hasFw eq 'T' }">checked="checked"</c:if> />是否启动发文
					<input type="checkbox"  name="hasQb" value="T"
					<c:if test="${object.hasQb eq 'T' }">checked="checked"</c:if> />是否启动签报
					
					<input type="checkbox"  name="caneditopt" value="T"
					<c:if test="${object.caneditopt eq 'T' }">checked="checked"</c:if> />是否编辑业务信息
					
					<input type="checkbox"  name="canphoneopt" value="F" 
					<c:if test="${object.canphoneopt eq 'F' }">checked="checked"</c:if> />只在PC端办理
				</td>
			</tr>
			<tr>
				...
				<c:if test="${object.hasDocument eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否编辑文书<span style="vertical-align:super; font-size:10px">[1]</span>
				
				<input type="checkbox"  name="hasStuff"  id="hasStuff" value="T"
				<c:if test="${object.hasStuff eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否有附件<span style="vertical-align:super; font-size:10px">[2]</span>
				
				<input type="checkbox"  name="isShowInNode" id="isShowInNode"  value="T"
				<c:if test="${object.isShowInNode eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否显示环节意见<span style="vertical-align:super; font-size:10px">[3]</span>
				
		</td>
			</tr>
			
			<tr>
				<td class="addTd" >部门|人员|配置</td>
				<td align="left" colspan="3">
				<input type="checkbox"  name="hasOrgRole" id="hasOrgRole" value="T"
				<c:if test="${object.hasOrgRole eq 'T' }">checked="checked"</c:if> onclick="doInitial();" />是否批分<span style="vertical-align:super; font-size:10px">[6]</span>  &nbsp;
				
				<input type="checkbox"  name="hasAttention" id="hasAttention" value="T"
				<c:if test="${object.hasAttention eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否有关注<span style="vertical-align:super; font-size:10px">[4]</span>
			
				<input type="checkbox"  name="assignTeamRole" id="assignTeamRole" value="T"
				<c:if test="${object.assignTeamRole eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否设置办件角色<span style="vertical-align:super; font-size:10px">[5]</span>
				...
				<input type="checkbox"  name="hasZbUser" id="hasZbUser" value="T"
				<c:if test="${object.hasZbUser eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否指定主办人<span style="vertical-align:super; font-size:10px">[8]</span>
				
				<input type="checkbox"  name="hasXbUser" id="hasXbUser" value="T"
				<c:if test="${object.hasXbUser eq 'T' }">checked="checked"</c:if> onclick="doInitial();"/>是否指定协办人<span style="vertical-align:super; font-size:10px">[9]</span>
		</td>
			</tr>
			
			<tr id="hasDocument_tr_1">
				<td class="addTd" >文书标签<span style="vertical-align:super; font-size:10px">[1]</span></td>
			  ...
			  <tr id="hasStuff_tr">
				<td class="addTd">附件材料分组<span style="vertical-align:super; font-size:10px">[2]</span></td>
			...
			<tr class="isShowInNode_tr">
				<td class="addTd" >环节意见标签<span style="vertical-align:super; font-size:10px">[3]</span></td>
			...
			<tr class="isShowInNode_tr">
				<td class="addTd" >环节意见模板<span style="vertical-align:super; font-size:10px">[3]</span>
			...
			<tr id="hasAttention_tr">
				<td class="addTd" >关注标签<span style="vertical-align:super; font-size:10px">[4]</span></td>
            ...
            <tr id="assignTeamRole_tr_1">
				<td class="addTd" >办件角色<span style="vertical-align:super; font-size:10px">[5]</span></td>
				<td align="left">
			...
			<tr id="assignTeamRole_tr_3">				
				<td class="addTd" >办件角色筛选式<span style="vertical-align:super; font-size:10px">[5]</span></td>
			 ...
			 <tr id="xbOrgRole_tr_1">
				<td class="addTd" >主办单位角色<span style="vertical-align:super; font-size:10px">[6]</span></td>
				<td align="left">
			...
			<td class="addTd" >协办单位标签<span style="vertical-align:super; font-size:10px">[6]</span></td>
			...
			<tr id="assignEngineRole_tr_2">
				<td class="addTd" width="130">权限引擎角色标签<span style="vertical-align:super; font-size:10px">[7]</span></td>
				<td align="left"><s:textfield name="engineRoleName" size="40"
						value="%{object.engineRoleName}" /></td>
				<td class="addTd" width="130">权限引擎表达式<span style="vertical-align:super; font-size:10px">[7]</span></td>
				<td align="left" colspan="3"><s:textfield name="engineRoleFilter" value="%{object.engineRoleFilter}" size="40"/></td>		
			</tr>

			
			<tr id="hasZbUser_tr_1">
				<td class="addTd" width="130">主办人角色<span style="vertical-align:super; font-size:10px">[8]</span></td>
					<td align="left">
						<select name="zbUserRoleCode" style="width:180px">
						 	<option value=""></option>
							<c:forEach var="row" items="${cp:DICTIONARY('WFTeamRole')}">
								<option value="${row.key}" <c:if test="${object.zbUserRoleCode eq row.key}"> selected = "selected" </c:if>>
								<c:out value="${row.value}" />U(${row.key})</option>
							</c:forEach>
						</select>
					</td>
			</tr>
			<tr id="hasZbUser_tr_2">
				<td class="addTd" width="130">主办人标签<span style="vertical-align:super; font-size:10px">[8]</span></td>
				<td align="left"><s:textfield name="zbUserLabel" size="40"
						value="%{object.zbUserLabel}" /></td>
				<td class="addTd" width="130">主办人表达式</td>
				<td align="left" colspan="3"><s:textfield name="zbUserFilter" value="%{object.zbUserFilter}" size="40"/></td>		
			</tr>
			<tr id="hasXbUser_tr_1">
				<td class="addTd" width="130">协办人角色<span style="vertical-align:super; font-size:10px">[9]</span></td>
					<td align="left">
						<select name="xbUserRoleCode" style="width:180px">
						 	<option value=""></option>
							<c:forEach var="row" items="${cp:DICTIONARY('WFTeamRole')}">
								<option value="${row.key}" <c:if test="${object.xbUserRoleCode eq row.key}"> selected = "selected" </c:if>>
								<c:out value="${row.value}" />U(${row.key})</option>
							</c:forEach>
						</select>
					</td>
			</tr>
			<tr id="hasXbUser_tr_2">
				<td class="addTd" width="130">协办人标签<span style="vertical-align:super; font-size:10px">[9]</span></td>
				<td align="left"><s:textfield name="xbUserLabel" size="40"
						value="%{object.xbUserLabel}" /></td>
				<td class="addTd" width="130">协办人表达式</td>
				<td align="left" colspan="3"><s:textfield name="xbUserFilter" value="%{object.xbUserFilter}" size="40"/></td>		
			</tr>
...
$(function(){
 ...
 $("#generalModuleParamForm_save").click(function(){
	...
	function doInitial() {
		...
		//主办人
		var hasZbUser_tr_1 = _get('hasZbUser_tr_1');
		var hasZbUser_tr_2 = _get('hasZbUser_tr_2');
		//协办人
		var hasXbUser_tr_1 = _get('hasXbUser_tr_1');
		var hasXbUser_tr_2 = _get('hasXbUser_tr_2');
		...
		//主办人
		if(_get('hasZbUser').checked){
			hasZbUser_tr_1.style.display = "table-row";
			hasZbUser_tr_2.style.display = "table-row";
		}else{
			hasZbUser_tr_1.style.display = "none";
			hasZbUser_tr_2.style.display = "none";
		}
		
		//协办人
		if(_get('hasXbUser').checked){
			hasXbUser_tr_1.style.display = "table-row";
			hasXbUser_tr_2.style.display = "table-row";
		}else{
			hasXbUser_tr_1.style.display = "none";
			hasXbUser_tr_2.style.display = "none";
		}
	}
