...
<body>
	...
	<h3 style="text-align:center;display:none" >办件信息打印</h3>
	<ec:table action="powerruntime/generalOperator!listIdeaLogs.do" items="ideaLogs" var="optIdeaInfo"
			imagePath="${STYLE_PATH}/images/table/*.gif" showPagination="false" showStatusBar="false" showTitle="false" border="1">
			<ec:row>
	...
	<span style="float: right"><a style="text-decoration: underline;color: blue" onclick="print()">打印</a></span>
   <%@ include file="/page/common/print.jsp"%>
	...
	function print(){
			...
			printView(function(LODOP){
				LODOP.PRINT_INIT("办件过程信息打印");
				LODOP.SET_PRINT_PAGESIZE(1, 0, 0, "A4");
				$(".form-container").find("td").each(function(){
					$(this).height($(this).height());
				});
				$(".form-container").find("td").css("text-align","center");
				$(".form-container").find("h3").show();
				LODOP.ADD_PRINT_HTM("150px","40px","650px","87%",$(".form-container").html());
				$(".form-container").find("h3").hide();
			});
	}
	</script>
	</body>
