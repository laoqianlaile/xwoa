...
<%-- 						<td class="searchCondArea">
						...
						<td class="searchCondArea">
							<s:submit method="unitlist"  key="opt.btn.query" cssClass="btn"/>
						</td>
					</tr>
				</table>
				</div>
		...
		<ec:table action="attendance/attendanceDetailed!unitlist.do" items="attendanceDetailedUnitlist" var="attendanceDetailed"
