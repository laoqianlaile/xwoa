			...
			<table cellpadding="0" cellspacing="0" align="left">
				<tr >
					...
					<tr >
						...
						<td><s:submit method="listIncomeDocTasks_gw" key="opt.btn.query" cssClass="btn"/>&nbsp;</td>
					</tr>		
                 </table>
             </s:form>
	</fieldset>

	<ec:table action="dispatchdoc/ioDocTasks!listIncomeDocTasks_gw.do" items="incomeDocList" var="userTask"
			imagePath="${STYLE_PATH}/images/table/*.gif" retrieveRowsCallback="limit">
			<ec:row>

				<ec:column property="acceptArchiveNo" title="收文编号" style="text-align:center" />
				<ec:column property="powername" title="公文类型" style="text-align:center"/>
