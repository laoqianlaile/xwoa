...
<%-- 			</c:if> --%>
			...
			<c:if test="${ ! empty object.createDate}">
				<input type="button" name="back" Class="btn" onclick="window.history.go(-1);" value="返回11" />
			</c:if>
			<input type="button" class="btn" id="save" name="saveBtn"  onclick="doSubmitCheck('SAVE');" value="保存"/>
			<input type="button" class="btn btnWide" id="saveAndSubmit" name="submitBtn" onclick="doSubmitCheck('SUB');" value="提交" />
			...
			<fieldset class="_new">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="viewTable">
					  ...
					  <%-- <tr>
						 <td class="addTd">
							...
							<td align="left" colspan="3">
								<select id="incomeDeptType" name="incomeDeptType" style="width: 200px;height:30px;">
				...
				<tr>
						...
						<td align="left" style="position:relative">
							...
							<input style="height:30px;" type="text" name="acceptArchiveNoPrex" id="acceptArchiveNoPrex" value="示范区安委办字" placeholder="请输入来文单位分类" onblur="acceptArchiveNoMouseout();"
								onkeyup="incomeAcceptAuto.handleEvent(this.value,'acceptArchiveNoPrex',event)"/>	
							</c:if>
					...
					<td class="addTd">
						...
						<tr>
							...
							<td align="left" colspan="3">
								<input type="text" id="remark" name="remark" maxlength="200" value="${object.incomeDocTitle}" style="width: 100%;height:30px;"/>
							</td>
