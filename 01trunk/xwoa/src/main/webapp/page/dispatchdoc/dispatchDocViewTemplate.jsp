...
<body>
	...
	<div class="form-container">
		...
		<!--WordStartExport-->
			...
			<div style="text-align: center; border-bottom: 2px solid red;font-size:20px;font-family:'FZYaoti'">
					...
					<c:if test="${object.itemId eq 'XW-FW-0002'}">
						<h2 style="color: red;">
							...
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameAJ')}（
							）
						</h2>
					</c:if>
					<c:if test="${object.itemId eq 'XW-FW-0005'}">
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameAWB')}（
							）
						</h2>
					</c:if>
					<c:if test="${object.itemId eq 'XW-FW-0006'}">
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameAJJ')}（
							）
						</h2>
					</c:if>
					<c:if
						...
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameHBJ')}（
							）
						</h2>
					</c:if>
					<c:if test="${object.itemId eq 'XW-FW-0004'}">
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameDQ')}（
							）
						</h2>
					</c:if>
					<!-- 规划建设局 -->
					<c:if test="${object.itemId eq 'XW-FW-0008'|| object.itemId eq 'XW-FW-0009' || object.itemId eq 'XW-FW-0010' || object.itemId eq 'XW-FW-0011'}">
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameGHJ')}（
							）
						</h2>
					</c:if>
					<!-- 监察室 -->
					<c:if test="${object.itemId eq 'XW-FW-0012'}">
						<h2 style="color: red;">
							<span class="remindIco remindIco-none"></span>
							<c:if test="${object.dispatchDocType eq 'PT'}"></c:if>
							<c:if test="${object.dispatchDocType eq 'ZG'}">中共</c:if>${cp:MAPVALUE('SYSPARAM','BizzNameJCS')}（
							）
						</h2>
					</c:if>
			</div>
<style>
.table_border{border:2px solid red;width: 100%; font-size: 14px; font-family: Microsoft YaHei;text-align: left}
.table_border td{border:2px solid red;height:40px;padding:0 0 0 5px}
.table_border td>label{display:inline-block;width:auto;}
</style>
		<table cellpadding="0" cellspacing="0" class='table_border'>
			...
			<!-- 管委会拟稿纸 -->
				...
				<tr>
	               ...
	               ${cp:MAPVALUE('WJLX',object.dispatchFileType)}〔20&nbsp;&nbsp;&nbsp;&nbsp;〕&nbsp;&nbsp;&nbsp;&nbsp;号
					...
					<td style="text-align:center;">
						<label style="color: red;text-align:center;">密级</label>
					</td>
					<td>
						 <frag:wordCellText
					...
					<td style="text-align:center;">
						<label style="color: red;text-align:center;">缓急程度</label>
					</td>
					<td>
						 <frag:wordCellText
				...
				<tr>
					...
					<td colspan="2" style="width:50px;">	
						...
						<td rowspan="6" style="text-align:center;">
							<label style="color: red;"><p>会</p><p>签</p></label>
						</td>
					...
					<tr>
						<td colspan="2" style="color: red;text-align: center;border: 2px solid red;">拟&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;办&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
						</td>
						<td colspan="2" style="color: red;text-align: center;border: 2px solid red;">审&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;核&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
						</td>
						<td colspan="3" style="color: red;text-align: center;border: 2px solid red;">签&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发
						</td>
					</tr>
					<tr>
					    <td colspan="2"  style="height:180px;border: 2px solid red;width:50px;">
							<frag:wordCellText
								cellText="${IDEA_5}" />
						</td>
					    <td colspan="2"  style="height:180px;border: 2px solid red;width:50px;">
						...
						<td colspan="3"  style="height:180px;border: 2px solid red;">
				...
				<tr>
					...
					<tr>
						<td colspan="3" style="color: red;text-align: center;border: 2px solid red;">审&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;核&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
						</td>
						<td colspan="3" style="color: red;text-align: center;border: 2px solid red;">签&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发
						</td>
				...
				<tr>
					...
					<tr>
						<td colspan="3" style="color: red;text-align: center;border-left:2px solid red;">审&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;核&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
						</td>
						<td colspan="3" style="color: red;text-align: center;border-left:2px solid red;">签&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发
						</td>
					</tr>
					<tr>
					    <td colspan="3" style="height:180px;border: 2px solid red;">
				...
				<tr>
					...
					<tr>
						<td colspan="1" style="color: red;text-align: center;border: 2px solid red;">拟&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;办&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
						</td>
						<td colspan="2" style="color: red;text-align: center;border: 2px solid red;">审&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;核&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;见
							<label style="color: red;"></label>
					...
					<tr>
					    <td colspan="1"  style="height:180px;border: 2px solid red;">
					    
						</td>
					    <td colspan="2"  style="height:180px;border: 2px solid red;">
							${IDEA_2}
						</td>
						<td colspan="3"  style="height:180px;border: 2px solid red;">
			...
			<c:if test="${object.itemId ne 'XW-FW-0001' && object.itemId ne 'XW-FW-0011' && object.itemId ne 'XW-FW-0002'}}">
			<tr>
					<td rowspan="2">
						<label style="color: red;border:2px solid red;"><p>信息公开</p><p>属性及</p><p>原因</p></label>
					</td>
					<td colspan="5">
						<p>
							<label style="color: red;">公开属性：
							 <c:forEach var="row"
			...
			<c:if test="${object.itemId eq 'XW-FW-0001' || object.itemId eq 'XW-FW-0011' || object.itemId eq 'XW-FW-0002'}">
			<tr>
					<td rowspan="2">
						<label style="color: red;border:2px solid red;"><p>信息公开</p><p>属性及</p><p>原因</p></label>
					</td>
			...
			<tfoot>							
				<tr>
					<td colspan="6" align="right" style="height: 50px; color: red;border:2px solid red">
			...
			<tfoot>							
				<tr>
					<td colspan="7" align="right" style="height: 50px; color: red;border:2px solid red">
						<span style="display: inline-block; margin-right: 30px;"> <c:if
								test="${not empty object.dispatchdate}">
								<fmt:formatDate value='${object.dispatchdate}'
									pattern='yyyy年MM月dd' />
...
<script type="text/javascript">
	...
	function print() {
		printView(function(LODOP) {
			...
			LODOP.ADD_PRINT_HTM("150px","50px","400px","70%",$(".form-container").html());
		});
	}
</script>
</html>