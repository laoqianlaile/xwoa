/**
 * reference CentitUI.util.date.js
...
(function($){
	...
	$.fn.datepicker = function(opts){
		...
		function keydownInt(e){
			if (!((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode == CentitUI.keyCode.DELETE || e.keyCode == CentitUI.keyCode.BACKSPACE))) { return false; }
		}
		...
		return this.each(function(){
			...
			$this.click(function(event){
				...
				$(CentitUI.frag['calendarFrag']).appendTo("body").css({
					left:offset.left+'px',
					top:iTop+'px'
