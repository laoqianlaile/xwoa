...
| Updated: 17.04.2003                               |
 updated: 2007-8-27 by zcy加入checkbox
|--------------------------------------------------*/
...
function dTree(imgRootpath,objName) {
	...
	this.icon = {
		...
		root				: imgRootpath+'/dtree/base.gif',

		folder			: imgRootpath+'/dtree/folder.gif',

		folderOpen	: imgRootpath+'/dtree/folderopen.gif',

		node				: imgRootpath+'/dtree/page.gif',

		empty				: imgRootpath+'/dtree/empty.gif',

		line				: imgRootpath+'/dtree/line.gif',

		join				: imgRootpath+'/dtree/join.gif',

		joinBottom	: imgRootpath+'/dtree/joinbottom.gif',

		plus				: imgRootpath+'/dtree/plus.gif',

		plusBottom	: imgRootpath+'/dtree/plusbottom.gif',

		minus				: imgRootpath+'/dtree/minus.gif',

		minusBottom	: imgRootpath+'/dtree/minusbottom.gif',

		nlPlus			: imgRootpath+'/dtree/nolines_plus.gif',

		nlMinus			: imgRootpath+'/dtree/nolines_minus.gif'
