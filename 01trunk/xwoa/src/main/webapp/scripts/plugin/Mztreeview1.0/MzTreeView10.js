...
function MzTreeView(Tname, referBox, referInput)
{
...
MzTreeView.prototype.focusClientNode      = function(id)
{
    ...
    var a = this.getElementById(this.name +"_link_"+ id); if(a && !$(a).parents('div.treebox:first').is(':hidden')){ a.focus();
