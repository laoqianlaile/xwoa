define(['jquery', 
	...
	$.publicinfo = {
			...
			FILE_OPTION : {
				...
				add_url: getContextPath()+'/app/publicinfo!addFolder.do',					// 添加文件夹
				...
				delete_url: getContextPath()+'/app/publicinfo!delete.do',					// 删除文件
			...
			dirPublicFolder: function(toPath) {
				...
				var path = toPath || $.publicinfo.FILE_OPTION.infocode;
				 ...
				 if (path ) {
					$.getJSON($.publicinfo.FILE_OPTION.public_url, {path:path, mode: $.publicinfo.MODE ,rootunitcode: $.publicinfo.UNITCODE  }, $.publicinfo.dirPublicFolderCallback);
				}
				else {
					$.getJSON($.publicinfo.FILE_OPTION.public_url, {mode: $.publicinfo.MODE  ,rootunitcode: $.publicinfo.UNITCODE }, $.publicinfo.dirPublicFolderCallback);
				}
			},
