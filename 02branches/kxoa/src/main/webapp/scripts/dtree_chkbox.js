...
|                                                   |
| Updated: 2010-06-23								|
| function: support checkbox object       			|
|--------------------------------------------------*/
...
function dTree(objName,iconPath) {
	this.config = {
		...
		inOrder					: false,
		check:false		//added by 2010-06-23, to control whether checkbox is showed
	};
	//modified at 2010-06-23, in order to make client can modify path of icons;
	...
	//added at 2010-06-23, to cache checkbox object and improve speed of set checked status
...
dTree.prototype.cc=function(nodeId){
	...
	/* comment by liujy at 2010-09-14,as cancel select parent node
