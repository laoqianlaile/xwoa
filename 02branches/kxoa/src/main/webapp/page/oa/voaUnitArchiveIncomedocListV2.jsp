...
<body>
	...
	<fieldset class="search">
		<legend class="headTitle"> 阅办文归档 </legend>
	<div class="searchDiv">
		...
		<ec:row>
			...
			<ec:column property="acceptarchiveno" title="阅办文号"
				style="text-align:center" width="7%">				
					 <c:choose>
						<c:when test="${fn:length(oaUnitArchiveIncomedoc.acceptarchiveno) > 10}">
							<c:out
								value="${fn:substring(oaUnitArchiveIncomedoc.acceptarchiveno, 0, 10)}..." />
						</c:when>
						<c:otherwise>
			...
			<ec:column property="incomedDocTitle" title="文件标题"
				...
				<a
					href='javascript:void(0)' onclick="viewDetail('${oaUnitArchiveIncomedoc.no }',0)">
					 <c:choose>
