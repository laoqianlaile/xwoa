		...
		<tr>
			<td width="22%" style="position: relative; background: #f0f6e4">
				<ul id="innermsg_tree" class="ztree"
					style="overflow-y: hidden; border: 1px solid #dddddd;; height: auto; position: absolute; width: 100%; margin: 0px; paddind: 5px 0px">
				</ul>
			</td>
			<td>
				<div class="row-fluid">
							...
							<fieldset class="_new">
								...
								<form method="post"
									...
									<input type="hidden" name="bodycode" value="${bodycode }" /> <input
										type="hidden" name="bodytype" value="${bodytype }" />
								...
								<a
										...
										<table border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td>电子邮件3:</td>
												<td colspan="3"><input type="text" class="{email:true}"
													name="email3" id="email3" value="${email3}"
													style="width: 145px;" /></td>
											</tr>
											<tr>
												<td>QQ：</td>
												<td><input type="text" class="{number:true}" name="qq"
													id="qq" value="${qq}" style="width: 145px;" /></td>
												<td>MSN：</td>
										...
										<table border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td>移动电话：</td>
												<td><input type="text" class="{telephone:true}"
													name="mobilephone" id="mobilephone" value="${mobilephone}"
													style="width: 145px;" /></td>
											</tr>
											<tr>
												<td>商务电话2：</td>
											...
											<tr>
												...
												<td><input type="text" class="{telephone:true}"
													...
													id="homefax" value="${homefax}" style="width: 145px;" /></td>
												<td>车载电话：</td>
												<td><input type="text" class="{telephone:true}"
										...
										<table border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td colspan="3"><input type="text"
													...
													id="unitzip" value="${unitzip}" style="width: 500px;" /></td>
											</tr>

											<tr>
												<td>单位省：</td>
												<td colspan="3"><input type="text" name="unitprovince"
													id="unitprovince" value="${unitprovince}"
											...
											<tr>
												<td>单位区：</td>
												<td colspan="3"><input type="text" name="unitdistrict"
													id="unitdistrict" value="${unitdistrict}"
													style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>单位街道：</td>
												<td colspan="3"><input type="text" name="unitstreet"
													id="unitstreet" value="${unitstreet}" style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>单位地址：</td>
											...
											<tr>
												...
												<td colspan="3"><input type="text"
													...
													id="homezip" value="${homezip}" style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅省：</td>
												<td colspan="3"><input type="text" name="homeprovince"
													id="homeprovince" value="${homeprovince}"
													style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅市：</td>
											...
											<tr>
												<td>住宅区：</td>
												<td colspan="3"><input type="text" name="homedistrict"
													id="homedistrict" value="${homedistrict}"
													style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅街道：</td>
												<td colspan="3"><input type="text" name="homestreet"
													id="homestreet" value="${homestreet}" style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅地址：</td>
											...
											<tr>
												<td>住宅省2：</td>
												<td colspan="3"><input type="text" name="home2province"
													id="home2province" value="${home2province}"
													style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅市2：</td>
											...
											<tr>
												<td>住宅区2：</td>
												<td colspan="3"><input type="text" name="home2district"
													id="home2district" value="${home2district}"
													style="width: 500px;" /></td>
											</tr>
											<tr>
												<td>住宅街道2：</td>
											...
											<tr>
												<td>住宅地址2：</td>
												<td colspan="3"><input type="text" name="home2address"
													id="home2address" value="${home2address}"
													style="width: 500px;" /></td>
											</tr>
										</table>
