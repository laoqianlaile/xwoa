...
<html>
<head>
<title><s:text name="oaInformation.edit.title" />
</title>
...
<body class="sub-flow">
	...
	<s:form action="oaInformation" method="post" namespace="/oa" id="oaInformationForm" enctype="multipart/form-data">
		<fieldset>
		<legend>	
...
<%-- 		<input type="hidden" id="infoType" name="infoType" value="${infoType}" /> --%>
		...
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable" style="height: 1124px">
			<tr>
				<td class="addTd"><s:text name="oaInformation.infoType" /><font color='red'>*</font></td>
				<td align="left">	${cp:MAPVALUE('infoType',infoType)}
				<input type="hidden" id="infoType" name="infoType" value="${infoType}">			
				...
				<td align="left">
					<select id="majorDegree"  style="width:200px;height:25px;"
						name="majorDegree"  >
							<option value="">---请选择---</option>
			...
			<tr>
			   ...
			   <td td align="left" >
			    <select id="state"  style="width:200px;height:25px;"
						name="state"  >
							<c:if test="${empty state }"><option value="">---请选择---</option></c:if>
			   ...
			   <td class="addTd">
					...
					<td align="left">
						<select name="isAllowComment"  style="width:200px;height:25px;">
			...
			<tr>
				...
				<select name="isTop" style="width:200px;height:25px;">
					<%-- <option value="" 
			...
			<tr>
				<td class="addTd"><s:text name="oaInformation.title" /><font color='red'>*</font></td>
				<td align="left" colspan="3"><s:textfield name="title" id="title"  style="width:90%;height:25px;" /></td>
			</tr>

			<tr>
				<td class="addTd"><s:text name="oaInformation.releaseDate" /><font color='red'>*</font>
				</td>
				<td align="left">
			...
			<tr>
				<td class="addTd"><s:text name="oaInformation.publicKey" />
				</td>
				<td align="left"><s:textfield name="publicKey" id="publicKey"  style="width:200px;height:25px;"/></td>
				<td class="addTd"><s:text name="oaInformation.docNo" /></td>
				<td align="left"><s:textfield name="docNo" size="40" id="docNo" style="width:200px;height:25px;"/></td>
			</tr>

			<tr>
				<td class="addTd"><s:text name="oaInformation.author" /></td>
				<td align="left"><s:textfield name="author" id="author" size="40"  style="width:200px;height:25px;"/></td>
				<td class="addTd"><s:text name="oaInformation.referenceLinks"/>
				</td>
				<td align="left"><s:textfield name="referenceLinks"  id="referenceLinks"  style="width:200px;height:25px;"/></td>
			</tr>
			<tr>
				  ...
				  <div class="fileList">
				     <ul>
				      <c:forEach var="fileItem" items="${docAttachments}">
				       <li><a href="${ctx}/oa/oaInformation!downLocalStuffInfo.do?no=${fileItem.id};return false;">${fileItem.fileName}</a>&nbsp;<a style="text-decoration: none;font-size: 12px" href="javascript:void(0);" onclick="removeAttachment(${fileItem.id},this)">删除</a></li>
				       </c:forEach>
				     </ul>
				  </div>
				...
				<td align="left" colspan="3" id="videoTD">
				   <div class="fileList">
				     <ul>
				       ...
				       <li><a href="${ctx}/oa/oaInformation!downLocalStuffInfo.do?no=${fileItem.id}">${fileItem.fileName}</a>&nbsp;<a style="text-decoration: none;font-size: 12px" href="javascript:void(0);" onclick="removeAttachment(${fileItem.id},this)">删除</a></li>
				       </c:forEach>
				     </ul>
				  </div>
				   <div class="inputFileArea">
				     <s:file name="video" size="40" style="width: 94%;" onchange="limitVideoFile(this)"/>
				     <a class="btnPlus" href="javascript:void(0);" onclick="appendInputFile(this);"></a>
				   </div>
				</td>
			 </tr>
			<tr style="height:800px">
				...
				<td align="left" colspan="3" ><s:textarea name="bodyContent"  id="newcontent" cols="40" rows="20" style="width: 100%;height:800px"/></td>
			</tr>
	...
	function submitItemFrame(subType){
		...
		if(subType == 'SAVE'){
			srForm.action = 'oaInformation!save.do';
		}
