...
<body>
	...
	<fieldset style="padding: 10px;">
		...
		<s:form action="lawmen" method="post" namespace="/powerbase" id="lawmenForm" enctype="multipart/form-data">
			...
			<input id="recoder" type="hidden" name="recoder" value="${object.recoder}" />
			<input id="recodDate" type="hidden" name="recodDate" value="${object.recodDate}" />
			...
			<tr>
					...
					<td align="left" ><input type="text" id="orgName" name="orgName"  value="${cp:MAPVALUE('unitcode',object.deptcode)}"/>
	...
	function save(){
		/*  var userName=document.getElementById("userName").value;
	     ...
	     form.action="lawmen!lawmenSave.do?flag="+${flag};     
	     form.submit();
