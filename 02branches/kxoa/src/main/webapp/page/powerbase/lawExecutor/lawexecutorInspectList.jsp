...
<html>
	...
	<body>
			...
			<s:form action="lawExecutor" namespace="/powerbase" style="margin-top:0;margin-bottom:5">
				<table cellpadding="0" cellspacing="0" align="center">
					...
					<tr>
						...
						<td></td>
						<td>
							<s:submit method="listInspect"  key="opt.btn.query" cssClass="btn"/>
		...
		<ec:table action="powerbase/lawExecutor!listInspect.do" items="objList" var="lawExecutor"
			...
			<ec:row>
				...
				<ec:column property="opt" title="操作" sortable="false"
					...
					<c:if test="${lawExecutor.status eq '1'}">
						<a href='powerbase/lawExecutor!inspect.do?staffno=${lawExecutor.staffno}&backurl=${backurl}'>年检</a>
					</c:if>
				</ec:column>
