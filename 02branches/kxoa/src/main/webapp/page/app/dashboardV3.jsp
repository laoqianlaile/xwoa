...
<div class="improveLeft" style="height: 92%;">
	<table>
		...
		<c:if test="${empty isLD}"> 
		  <td class='fw_custom'>
				<div title="拟发文待办" rel="FWGLFWDB" style="cursor:pointer;">
			...
			<td class='sw_custom'>
				<div title="阅办文待办" rel="SWGLSWDB" style="cursor:pointer;">
			...
			<c:if test="${not empty isLD and isLD eq 'true'}">
			 <td class='zxfw_custom'>
				<div title="拟发文待办" rel="ZXFWGLFWDB">
					<span id="fwTaskNumSpan">${fwTaskNum }</span>
					<div class="td_link">
					审批
					<a></a>
			...
			<td class='zxsw_custom'>
				<div title="阅办文待办" rel="ZXSWGLSWDB">
			...
			<td class='gg_custom'>
				<div title="来文未读待办" style="cursor:pointer;">
			...
			<td class='yj_custom'>
				<div title="未读邮件" class="yj" style="cursor:pointer;">
					<div class="td_link_left">
						<span id="unReadEmailNumSpan">未读邮件&nbsp;&nbsp;${unReadEmailNum }</span><a></a> 
					</div>
				</div>
				<div title="提醒" class="tx" style="cursor:pointer;">
					<div class="td_link_left">
...
<!-- 	<div>版权所有：南京市总工会 &nbsp;&nbsp;&nbsp;技术支持：江苏南大先腾信息产业股份有限公司 </div> -->
</div>
   ...
   // 设置内部资讯初始高度
    ...
    $(function(){
    	...
    	$('#unReadEmailNumSpan').click(function(){
    		openMenu(this, 'wdyj', "<%=request.getContextPath()%>/oa/innermsg!recList.do?s_msgtype=P&s_mailtype=I&s_msgstate=U&s_showtype=F");
    	});
