		...
		<div class="content">
			...
			<s:form action="oaBbsTheme" method="post" namespace="/bbs"
				...
				<table width="200" border="0" cellpadding="1" cellspacing="1">
					...
					<%-- <tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.themeno" />
					</td>
					<td align="left">
					...
					<%-- <tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.layoutno" />
					</td>
					<td align="left">
	
  
						<s:textfield name="layoutno"  size="40"/>
				...
				<tr>
					...
					<td align="left">
						...
						<s:textfield name="approval"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.approvalresults" />
					</td>
					<td align="left">
	
  
						<s:textfield name="approvalresults"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.approvaltime" />
					</td>
					<td align="left">
	
  
						<s:textfield name="approvaltime"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.approvalremark" />
					</td>
					<td align="left">
  
						<s:textarea name="approvalremark" cols="40" rows="2"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.postsnum" />
					</td>
					<td align="left">
	
  
						<s:textfield name="postsnum"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.postsviewnum" />
					</td>
					<td align="left">
	
  
						<s:textfield name="postsviewnum"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.lastmodifytime" />
					</td>
					<td align="left">
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.themeset" />
					</td>
					<td align="left">
	
  
						<s:textfield name="themeset"  size="40"/>
				...
				<tr>
					<td class="TDTITLE">
						<s:text name="oaBbsTheme.attentionum" />
					</td>
					<td align="left">
	
  
						<s:textfield name="attentionum"  size="40"/>
