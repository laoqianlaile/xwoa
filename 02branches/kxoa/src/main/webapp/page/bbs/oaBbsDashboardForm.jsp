		...
		<form
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left"><select id="unitcode" name="unitcode" style="width: 200px;" class="focused required">
					...
					<td align="left"><select name="openType" style="width: 200px;" class="focused required">
				...
				<tr>
					...
					<td align="left"><input type="text" name="orderno" class="focused required number"
						value="${object.orderno }" style="width: 200px; height: 24px;"/></td>
				</tr>
				...
				<tr>
					...
					<td align="left" colspan="3"><input type="text" readonly="readonly"
						...
						name="approvalNames" rows="1" cols="1" style="width: 100%; height: 24px"
				...
				<tr>
					...
					<td align="left" colspan="3">
					    <select id="isdocontral" name="isdocontral" style="width: 200px;" class="focused required" >
							<option value="F"
