...
<!-- 								<option value="">---请选择---</option> -->
				...
				<td class="addTd">子版块名称：<font color="#ff0000">*</font></td>
					<td align="left"><input type="text" name="sublayouttitle"
						...
						style="width: 200px; height: 24px;" class="focused required" /></td>
				</tr>		
				<tr>
				...
				<tr>
					...
					<td align="left"><input type="text" name="orderno"
						value="${object.orderno }" style="width: 200px; height: 24px;"
				...
				<tr>
					...
					<td align="left"><select name="isneed" style="width: 200px;"
                   ...
                   <td class="addTd">是否公开：<font color="#ff0000">*</font></td>
					<td align="left"><select name="openType" style="width: 200px;"
						class="focused required">
				...
				<tr>
					...
					<td align="left"><select id="isdocontral" name="isdocontral"
						style="width: 200px;" class="focused required">
							<option value="F"
