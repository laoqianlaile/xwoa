...
<%--                 <li url="${pageContext.request.contextPath}/oa/oaInformation!oaInfomationMainpage.do" target="_blank" rel="external_OAHELPINFO" external="true"><a >新闻动态</a></li>		<!--暂时屏蔽，用户内网有内网门户，此块暂不开放  -->		 --%>
			</ul>
