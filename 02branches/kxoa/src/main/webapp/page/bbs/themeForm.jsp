		...
		<form action="${pageContext.request.contextPath}/bbs/oaBbsTheme!themeSave.do" method="post"
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left" ><select name="themeset" style="width: 200px;">
				...
				<tr>
					<td class="addTd">审核结果：</td>
						<td align="left" colspan="3">
							<select name="approvalresults" style="width: 200px;">							
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="approvalremark"
							id="approvalremark" value="${object.approvalremark }" style="width: 100%; height: 24px" /></td>
					</tr>
				</c:if>
				...
				<tr>
					...
					<td colspan="3"><textarea name="bodycontent" id="bodycontent" cols="40"
							rows="7" style="width: 98%;">${object.bodycontent }
						</textarea> </td>
				</tr>
