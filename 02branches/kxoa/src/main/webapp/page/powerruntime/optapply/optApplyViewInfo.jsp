...
<body>
   ...
   <div class="form-container"  >
           ...
           <h2 style="color:red;font-family: Microsoft YaHei;text-align:center;padding-top:10px;">
			${cp:MAPVALUE('SYSPARAM','BizzName')}&nbsp;<c:if test="${itemType eq 'SQ' }">事权</c:if><c:if test="${itemType eq 'QB' }">签 报</c:if> 单
			</h2>
			</br>
      		<table cellpadding="0" cellspacing="0" style="width:100%;border:1px #e8e8e8 solid; border-collapse:collapse;font-size:14px;font-family: Microsoft YaHei;text-align:left;table-layout: fixed;">
				...
				<tr>
					<td style="border:1px #e8e8e8 solid;text-align:center;height:40px;font-weight: bold;width:130px;">
						事项内容
					<td style="border:1px #e8e8e8 solid;padding-left:10px;" colspan="3" style='border-bottom: 0px'>
						${optBaseInfo.content}
					</td>
				</tr>
				</c:if>
...
<%-- 				   <fmt:formatDate value="${optBaseInfo.createdate }" pattern="yyyy-MM-dd" /> --%>
				   ...
				   <td style="border:1px #e8e8e8 solid;text-align:center;height:40px;font-weight: bold;width:130px;">
					...
					<div id="remindDiv" ></div><font><c:if test="${empty optBaseInfo.criticalLevel}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</c:if>
						${cp:MAPVALUE("critical_level",optBaseInfo.criticalLevel)}
					</td>					
				</tr>
				<tr>
				    <td style="border:1px #e8e8e8 solid;text-align:center;height:40px;font-weight: bold;width:130px;">
				...
				<tr>
					<td style="border:1px #e8e8e8 solid;text-align:center;height:40px;font-weight: bold;width:130px;" style="border-bottom: 0px">
						签报内容					
					<td style="border:1px #e8e8e8 solid;padding-left:10px;" colspan="3" style="border-bottom: 0px">
						${optBaseInfo.content}
					</td>
