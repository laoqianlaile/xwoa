...
<!-- 	<input type="button"  value="返回" Class="btn"  onclick="window.history.back()"/> -->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="viewTable">		
				<tr>
					...
					<td align="left">
						<input type="text" name="userName" id="userName" style="width:85%;height:35px;" readonly="readonly" value="${cp:MAPVALUE('usercode',object.grantee)}" onclick="onclickSelectUser()"/>
...
<%-- 							yearRange="2000:2020" displayFormat="yy-mm-dd" changeYear="true" /> --%>
				...
				<tr>
					...
					<td align="left">
						<s:textarea name="grantdesc" id="grantdesc" style="width:100%;" rows="2" value="%{object.grantdesc}"/>
					</td>
				</tr>
