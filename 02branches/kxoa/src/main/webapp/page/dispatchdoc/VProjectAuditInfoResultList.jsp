...
<html>
	...
	function SWPrint() {
		...
		var param = "FileType=.doc&flowStep=SW_DIR&EditType=1,0&ShowType=1" +"&Template=JGGS";
		...
		<fieldset>
			...
			<s:form action="VProjectAuditInfo" namespace="/dispatchdoc" style="margin-top:0;margin-bottom:5">
				...
				<s:hidden name="s_isUpload" value="%{#parameters['s_isUpload']}"/>
...
<%-- 						 displayFormat="yy-mm-dd" changeYear="true" /> --%>
		...
		<ec:table action="dispatchdoc/VProjectAuditInfo!listResult.do" items="objList" var="VProjectAuditInfo"
			...
			<ec:row>
				...
				<ec:column property="solvetimeStr" title="批准时间" style="text-align:center" />
				<ec:column property="incomeDeptName" title="项目申请人" style="text-align:center" />
				<ec:column property="projectName" title="项目名称" style="text-align:center" />
				<ec:column property="buildContent" title="主要建设内容" style="text-align:center" />
				<ec:column property="sendArchiveNo" title="批准文号" style="text-align:center" />
			</ec:row>
		</ec:table>
	</body>
</html>