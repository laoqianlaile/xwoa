		...
		<ec:table action="dispatchdoc/VUserTransaffair!list.do" items="objList" var="VUserTransaffair"
			...
			<ec:row>
				...
				<ec:column property="opt" title="${optlabel}" sortable="false"
					...
					<a href="#" onclick="popWin('${VUserTransaffair.flowInstId}');">会办处室</a>
				</ec:column>
...
<script type="text/javascript">
	...
	function popWin(flowInstId) {
		var url =  "${contextPath}/sampleflow/sampleFlowManager!preHbcsOrganize.do?flowInstId="+flowInstId+"&roleCode=hbcsfb&isHidden=1" ;
