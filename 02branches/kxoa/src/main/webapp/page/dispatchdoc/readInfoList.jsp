...
<%-- 						changeYear="true" readonly="true" cssStyle="width: 100px;" /> --%>
		...
		<ec:table action="dispatchdoc/readInfo!list.do" items="infoList" var="readInfo"
			...
			<ec:row>
				...
				<ec:column property="opt" title="操作" sortable="false"
					...
					<a href='readInfo!edit.do?readNo=${readInfo.readNo}'>编辑</a>
					<a href='readInfo!delete.do?readNo=${readInfo.readNo}' 
