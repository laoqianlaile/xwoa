...
<body>
	...
	<s:form method="post" action="dispatchDoc!saveDispatchDoc.do" namespace="/dispatchdoc"
...
<input type="hidden" id="flowCode" name="flowCode"  value="${flowCode}" >
				<tr>
					...
					<td align="left">
					<input type="hidden" name="optBaseInfo.transAffairNo" value="${object.optBaseInfo.transAffairNo}" />
...
<!-- 办件信息  <<<<<<<<<<<<<<< -->					
				...
				<tr>
					...
					<td>
					<select name="dispatchFileType" style="width: 180px">
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" name="unionOthers"
						value="${object.unionOthers}" style="width: 100%; height: 40px;" />（动态添加，“,”号分割）
					</td>
				</tr>
				<tr>
					<td width="130">文件摘要</td>
					<td colspan="3">
						<input type="text" name="dispatchDocSummary" style="width:100%;height:40px;" value="${object.dispatchDocSummary}" /> 
					</td>
				</tr>
