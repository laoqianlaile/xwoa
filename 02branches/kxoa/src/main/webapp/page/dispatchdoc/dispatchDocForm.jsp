...
<body class="sub-flow" style=" text-align: center;">
	...
	<s:form method="post" namespace="/dispatchdoc" action="dispatchDoc!saveDispatchDocByIncomeDoc.do" name="dispatchDocForm" id="dispatchDocForm">
		<center id="operatorArea" style="display: none;">
		...
		<fieldset style="padding: 10px; display: block; margin-bottom: 10px;">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable" style="  position:relative;width:98%;margin-left: auto;margin-right: auto;">
				...
				<tr>
					<td class="addTd">拟发文代<span style="font-family:Simsun !important">字</span><font color="#ff0000">*</font>
					</td>
				...
				<tr>
					<td class="addTd">文件摘要<font color="#ff0000">*</font>
					</td>
				...
				<span id="formEditControlArea" style="display: none;"><input type="button" style="margin-top: 15px" id="completeFormBtn" Class="btn" value="完成" /></span>
<!-- 		</fieldset> -->
	</s:form>
</body>
<script type="text/javascript">
	...
	function doCheck() {
		...
		/* if ("1" == $("#isUnionDispatch").val() && !(validateEmpty("unionDispatchUnits", "请输入联合发文部门")
				&& validateLength("unionDispatchUnits", 500, "联合拟发文部门超出最大长度"))) {
			return false;
		} */
		if ("1" == $("#isCountersign").val() && !validateEmpty("orgCode", "请选择会签处室")) {
			return false;
		}
		if (!(validateEmpty("dispatchCanOpen", "请选择是否信息公开")
				&& validateEmpty("dispatchCanOpen", "请选择公开方式")
				&& validateEmpty("dispatchDocSummary", "请输入文件摘要")
				&& validateLength("dispatchDocSummary", 500, "文件摘要超出最大长度")
