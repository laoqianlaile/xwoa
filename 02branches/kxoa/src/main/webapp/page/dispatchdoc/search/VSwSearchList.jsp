...
<!--  	<p/> -->
 	...
 	<ec:table action="swSearch!list.do" items="objList" var="swSearch" imagePath="${STYLE_PATH}/images/table/*.gif" filterRowsCallback="limit"
		...
		<ec:row>
			<ec:column property="incomeDate" title="阅办文日期" style="text-align:center;word-break: keep-all; white-space: nowrap;" sortable="true" cell="date" format="yyyy-MM-dd"/>
