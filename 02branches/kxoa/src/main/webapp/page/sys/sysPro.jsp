...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
	    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
		  ...
		  <tr bgcolor="#FFFFFF">
		    <td width="25%" bgcolor="#FFFFFF" align="right">用户,目录,Tomcat服务目录：</td>
		    <td><%=System.getProperty("user.name") %>,<%=System.getProperty("user.home") %>,<%=application.getRealPath("/")%></td>
		  </tr>
		  <tr bgcolor="#FFFFFF">
		  ...
		  <tr bgcolor="#FFFFFF">
		    <td width="25%" bgcolor="#FFFFFF" align="right">总内存/剩余内存/使用内存：</td>
		    <td>
                <% OperatingSystemMXBean osmb = (OperatingSystemMXBean) ManagementFactory.getOperatingSystemMXBean();%>
				<b><%=osmb.getTotalPhysicalMemorySize() / 1024/1024 %></b>MB&nbsp;&nbsp;/&nbsp;&nbsp;<b><%=osmb.getFreePhysicalMemorySize() / 1024/1024 %></b>MB&nbsp;&nbsp;/&nbsp;&nbsp;<b><%=osmb.getTotalPhysicalMemorySize() / 1024/1024-osmb.getFreePhysicalMemorySize() / 1024/1024 %></b>MB
            </td>
		  </tr>
		</table>
	</body>
