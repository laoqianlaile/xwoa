...
<table border="0" cellpadding="0" cellspacing="0" class="viewTable">		
  <tr>
    ...
    <c:if test="${empty object.usercode}"> <s:textfield id="usercode" name="usercode"  style="width:200px;height:25px;" /></c:if>
    ...
    <td><label>
      <s:textfield   id="username"  name="username"  style="width:200px;height:25px;" />
    ...
    <td><label>
      <s:textfield  id="loginname"  name="loginname" style="width:200px;height:25px;" />
  	...
  	<tr>
		...
		<td align="left">
					...
					<input type="text" id="orgName" name="orgName" style="height:25px;width:200px;" value="${cp:MAPVALUE('unitcode',userUnit.unitcode)}">
	...
	<tr>
		...
		<td align="left" >
			...
			<select id="userstation" name="userUnit.userstation"  style="width:200px;height:25px;">      
	...
	<tr>
		...
		<td align="left" >
			...
			<select id="userrank" name="userUnit.userrank" style="width:200px;height:25px;"> 
				<option value="">---请选择---</option>     
	...
	<tr>
		...
		<td><s:textfield id="userorder" name="userorder" value="%{object.userorder}" style="width:200px;height:25px;"></s:textfield>  
		<span id="userorderTip" ></span></td>
	
	</tr>
	<tr>
		<td class="addTd">办公电话</td>
		<td><s:textfield id="officePhone" name="officePhone" value="%{object.officePhone}" style="width:200px;height:25px;"></s:textfield> 
		 <span id="officePhoneTip" ></span></td>
	</tr>
	<tr>
		<td class="addTd">排序号</td>
		<td><s:textfield id="sortid" name="sortid" value="%{object.sortid}" style="width:200px;height:25px;"></s:textfield> 
