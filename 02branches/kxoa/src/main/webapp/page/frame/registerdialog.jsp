...
<div class="pageFormContent" layoutH="58">
	...
	<div class="unit">
		<label>显示姓名：</label> 
		<input type="text" type="text"  name="username"  minlength="1"
			maxlength="12" class="required">
	</div>
	<div class="unit">
		<label>确认Email：</label> 
		<input type="text" type="text" name="regemail"  minlength="5"
	...
	<div class="unit">
		<label>验证码：</label> 
		<input type="text" type="text"  name="captchaVal"  class="required">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
