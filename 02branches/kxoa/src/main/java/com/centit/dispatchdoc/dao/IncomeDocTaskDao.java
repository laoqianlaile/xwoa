...
public class IncomeDocTaskDao extends BaseDaoImpl<IncomeDocTask>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(IncomeDocTaskDao.class);
	...
	public IncomeDocTask getObjectByDjId(String djId){
	    String shql = " from IncomeDocTask where djId=? ";
        Object[] objects = new Object[]{djId};
        List<IncomeDocTask> Applys = this.listObjects(shql, objects);
    ...
    public List<IncomeDocTask> listIncomeDocTask_GW(
        ...
        String shql = "FROM v_user_task_list_sw where 1=1 and flowCode in ('000535','000536','000730','000692','000711','000530','000534','000533','000531') ";
