...
public class VUserTransaffairAttentionDao extends BaseDaoImpl<VUserTransaffairAttention>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(VUserTransaffairAttentionDao.class);
	...
	public Map<String, String> getFilterField() {
		if( filterField == null){
			...
			filterField.put("attUser" , CodeBook.LIKE_HQL_ID);
