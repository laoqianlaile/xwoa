...
public class VUserTransaffairDcyjDao extends BaseDaoImpl<VUserTransaffairDcyj>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(VUserTransaffairDcyjDao.class);
	...
	public Map<String, String> getFilterField() {
		if( filterField == null){
			...
			filterField.put("dcyj" , CodeBook.LIKE_HQL_ID);
