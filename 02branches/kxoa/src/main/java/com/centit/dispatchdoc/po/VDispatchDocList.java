...
public class VDispatchDocList implements java.io.Serializable {
    ...
    public VDispatchDocList(String djId, String internalNo, String itemId,
            ...
            String dispatchUser, String nodename, String bizusernames) {
        super();
        this.djId = djId;
    ...
    public VDispatchDocList(String djId, String internalNo, String itemId,
            ...
            String solvestatus, Date solvetime, String solvenote,
            String usercode, Date createdate2, String sendArchiveNo,
            String acceptArchiveNo,String dispatchUser) {
        super();
        this.djId = djId;
        this.internalNo = internalNo;
        this.itemId = itemId;
    ...
    public VDispatchDocList(String djId, String internalNo, String itemId,
            ...
            String acceptArchiveNo,String dispatchUser,String nodename,String bizusernames,String unitcode){
        this.djId=djId;
        this.internalNo = internalNo;
        this.itemId = itemId;
        this.dispatchDocNo = dispatchDocNo;
