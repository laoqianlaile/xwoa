...
public class VUserTransaffair implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VUserTransaffair() {
    }

    /** minimal constructor */
    public VUserTransaffair(String transId) {
    ...
    /** full constructor */
    public VUserTransaffair(String transId, String djId, String optId,
            ...
            String riskResult, String isUpload, String userCode,
            ...
            String fwh, String wjlx, Date acceptDate, String zbcbrTransContent, String dispatchDocTitle) {
