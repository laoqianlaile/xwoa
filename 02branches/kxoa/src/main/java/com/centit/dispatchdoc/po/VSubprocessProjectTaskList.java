...
public class VSubprocessProjectTaskList implements java.io.Serializable{
    /**
     * 
     */
    ...
    public VSubprocessProjectTaskList(Long taskId, Long nodeInstId,
            String unitCode, String userCode, Long flowInstId, String authDesc,
            String flowOptName, String flowOptTag, String nodeName,
            String nodeType, String nodeOptType, String optName,
            String methodName, String optId, String optParam, String optUrl,
            ...
            Date flowExpireTime, Long flowTimeLimit, String djId,
            ...
            String solvenote, String createuser, String riskType,
            String riskDesc, String riskResult, String transAffairNo,
            String transAffairQueryKey, Date createdate, String sendArchiveNo,
            String acceptArchiveNo, String flowPhase) {
        super();
        this.taskId = taskId;
        this.nodeInstId = nodeInstId;
        this.unitCode = unitCode;
    ...
    public VSubprocessProjectTaskList() {
        super();
