...
public class VUserTransaffairDao extends BaseDaoImpl<VUserTransaffair> {
    private static final long serialVersionUID = 1L;
    public static final Log log = LogFactory.getLog(VUserTransaffairDao.class);
    ...
    public Map<String, String> getFilterField() {
        if (filterField == null) {
            ...
            filterField.put("IN_bizstate", CodeBook.EQUAL_HQL_ID);
            
            filterField.put("IN_subItemType", CodeBook.EQUAL_HQL_ID);
            ...
            filterField.put("headusercode", CodeBook.EQUAL_HQL_ID);
            ...
            filterField.put("solvetime", CodeBook.EQUAL_HQL_ID);
            ...
            filterField.put("riskType", CodeBook.EQUAL_HQL_ID);
            ...
            filterField.put("NP_fwhNotNull", " fwh is not null");
            
            filterField.put("zbUnitName", " headunitcode in (select unitcode from FUnitinfo where unitname like ? or unitshortname like ?)");

            filterField.put("hbUnitNames", " (hbUnitNames like ? or hbUnitShortNames like ?)");
