...
public class VUserTransaffairDcyjGr implements java.io.Serializable {
	...
	private String  zbcbrTransContent;
	private String  dispatchDocTitle;
	private String  dcyj;

	// Constructors
	/** default constructor */
	public VUserTransaffairDcyjGr() {
	}
	/** minimal constructor */
	public VUserTransaffairDcyjGr(
		String transId		
...
/** full constructor */
	public VUserTransaffairDcyjGr(
	 String transId		
	,String  leaderName,Date  shipDate,String  unitName,String  leaderNote,String  djId,String  optId,String  flowCode,Long  flowInstId,String  transAffairNo,String  transaffairname,String  transAffairQueryKey,String  bizstate,String  biztype,String  orgcode,String  orgname,String  headunitcode,String  headusercode,String  content,String  powerid,String  powername,String  solvestatus,Date  solvetime,String  solvenote,String  createuser,Date  createdate,String  caseNo,String  sendArchiveNo,String  acceptArchiveNo,String  riskType,String  riskDesc,String  riskResult,String  isUpload,String  userCode,String  subItemType,String  incomeDocNo,String  incomeDeptType,String  incomeDeptName,String  zbUnitName,String  zbUnitShortName,String  hbUnitNames,String  hbUnitShortNames,String  docTitle,String  fwh,String  wjlx,Date  acceptDate,String  zbcbrTransContent,String  dispatchDocTitle,String  dcyj) {
		...
		this.zbcbrTransContent= zbcbrTransContent;
	...
	public String getZbcbrTransContent() {
		return this.zbcbrTransContent;
	}
	
	public void setZbcbrTransContent(String zbcbrTransContent) {
		this.zbcbrTransContent = zbcbrTransContent;
	}
	...
	public void copy(VUserTransaffairDcyjGr other){
		...
		this.zbcbrTransContent= other.getZbcbrTransContent();  
		this.dispatchDocTitle= other.getDispatchDocTitle();  
		this.dcyj= other.getDcyj();

	}
	
	public void copyNotNullProperty(VUserTransaffairDcyjGr other){
	...
	if( other.getTransId() != null)
		...
		if( other.getAcceptDate() != null)
			this.acceptDate= other.getAcceptDate();  
		if( other.getZbcbrTransContent() != null)
			this.zbcbrTransContent= other.getZbcbrTransContent();  
		if( other.getDispatchDocTitle() != null)
			this.dispatchDocTitle= other.getDispatchDocTitle();  
		if( other.getDcyj() != null)
			this.dcyj= other.getDcyj();
