...
public class Innermsg implements java.io.Serializable {
    ...
    public static final String MSG_STAT_S = "S";
    ...
    private Set<InnermsgRecipient> innermsgRecipients = null;// new
    ...
    private String isAuto;//定时发送 T，F
    ...
    private String topMsgcode;//回复(转发)邮件id
    private String  topType;// '1 转发 2 回复';
    // Constructors
    /** default constructor */
    public Innermsg() {
    }
    ...
    /** full constructor */
    public Innermsg(String msgcode, String sender, Date senddate,
            String msgtitle, String msgtype, String mailtype,
            String receivename, Long holdusers, String msgstate,
            String msgcontent, String emailid, String ccName, String bccName,
            String isAuto,String topMsgcode ,String  topType) {
     ...
     * 
     */
    public void replaceInnermsgRecipients(
            List<InnermsgRecipient> innermsgRecipients) {
        ...
        for (InnermsgRecipient newdt : newObjs) {
            found = false;
            for (Iterator<InnermsgRecipient> it = getInnermsgRecipients()
                    .iterator(); it.hasNext();) {
                InnermsgRecipient odt = it.next();
                if (odt.getId().equals(newdt.getId())) {
                    odt.copy(newdt);
    ...
    public void copy(Innermsg other) {
        ...
        this.ccName = other.getCcName();
        this.bccName = other.getBccName();
        this.isAuto = other.getIsAuto();
    }
    ...
    public void copyNotNullProperty(Innermsg other) {
        ...
        if (other.getCc() != null)
            this.cc = other.getCc();
        if (other.getBcc() != null)
            this.bcc = other.getBcc();
        if (other.getCcName() != null)
            this.ccName = other.getCcName();
        if (other.getBccName() != null)
            this.bccName = other.getBccName();
        if (other.getIsAuto() != null)
            this.isAuto = other.getIsAuto();
        // if (other.getEmailid() != null)
        // this.emailid = other.getEmailid();
        replaceInnermsgRecipients(new ArrayList<InnermsgRecipient>(
                other.getInnermsgRecipients()));
        replaceMsgannexs(new ArrayList<Msgannex>(other.getMsgannexs()));
        // this.msgannexs = other.getMsgannexs();
        // this.innermsgRecipients = other.getInnermsgRecipients();
    }
    ...
    public String getIsAuto() {
        if (StringUtils.isBlank(this.isAuto)) {
            this.isAuto = "F";
        }
        return isAuto;
    }
    ...
    public String getTopMsgcode() {
        return topMsgcode;
    }

    public void setTopMsgcode(String topMsgcode) {
        this.topMsgcode = topMsgcode;
    }
