...
public class VoaUnitArchiveIncomedocDao extends BaseDaoImpl<VoaUnitArchiveIncomedoc>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(VoaUnitArchiveIncomedocDao.class);
	...
	public Map<String, String> getFilterField() {
		if( filterField == null){
			...
			filterField.put("incomeDocType" , CodeBook.LIKE_HQL_ID);

			filterField.put("itemSource" , CodeBook.LIKE_HQL_ID);
			
			filterField.put(CodeBook.ORDER_BY_HQL_ID,"income_date desc");
	 ...
	 private Map<String,String> returnDbField(Map<String,String> params){
	        ...
	        if(params != null){
	            for(Map.Entry<String,String> entry : params.entrySet()){
	                if("endincomeDate".equals(entry.getKey())){
	                ...
	                }else if("itemSource".equals(entry.getKey())){
                        res.put("ITEM_SOURCE", entry.getValue());
	                    ...
	                    res.put(CodeBook.ORDER_BY_HQL_ID, " income_date desc,no");
	                }
	                else{
	    ...
	    public List<String> findNeighbouringDjId(Map<String, Object> filterMap,String currDjId){
	        String shql = "select * from V_OA_ARCHIVE_INCOMEDOC where 1=1 ";
