...
public class OaSpecialBudgetAction  extends OACommonBizAction<OaSpecialBudget>  {
	private static final Log log = LogFactory.getLog(OaSpecialBudgetAction.class);
	private static final long serialVersionUID = 1L;
	private OaSpecialBudgetManager oaSpecialBudgetMag;
	public void setOaSpecialBudgetManager(OaSpecialBudgetManager basemgr)
	{
		oaSpecialBudgetMag = basemgr;
		this.setBaseEntityManager(oaSpecialBudgetMag);
	}
     ...
     public String list() {
         ...
         objList = oaSpecialBudgetMag.listObjects(filterMap, pageDesc);
     ...
     */
     ...
     public String edit() {
         ...
         if (StringUtils.isBlank(object.getDjId())) {
             object.setDjId(optApplyManager.getNextDjId("SQ","OaSpecialBudget"));//主键生成策略
    ...
    //                  否则  只保留上下文 /oa_szgh
     ...
     public String savePermitReg() {
         try {
             ...
             // 申请state=6标记为暂存
             oaSpecialBudgetMag.saveObject(object);

             object = oaSpecialBudgetMag.getObjectById(object.getDjId());
     ...
     public String saveAndSubmit() {
         ...
         // 保存
         FUserDetail fuser = ((FUserDetail) getLoginUser());
         OaSpecialBudget OaSpecialBudget = oaSpecialBudgetMag
                 .getObjectById(object.getDjId());
         if (OaSpecialBudget != null) {
             oaSpecialBudgetMag.copyObject(OaSpecialBudget, object);
             object = OaSpecialBudget;
         }
         object.setCreater(fuser.getUsercode());
     ...
     public String delete() {
         if (StringUtils.isNotBlank(object.getDjId())) {
             ...
             oaSpecialBudgetMag.deleteObjectById(object.getDjId());
         }
         return "nextList";
     }
     ...
     public String saveReditSQ() {
         OaSpecialBudget OaSpecialBudget = oaSpecialBudgetMag
                 .getObjectById(object.getDjId());
         if (OaSpecialBudget != null) {
             oaSpecialBudgetMag.copyObjectNotNullProperty(
                     OaSpecialBudget, object);
             object = OaSpecialBudget;
         }
         oaSpecialBudgetMag.saveObject(object);
