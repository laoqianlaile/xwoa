...
public class Cryptos {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        //加密
        System.out.println("=====================AES加密开始====================");
        //用AES128，产生用HEX编码后的密钥
        String strKey128 =  generateAesKeyString();
        System.out.println("密钥(hex编码):"+strKey128);
        //明文
        String plaintext = "kySAiF";
        System.out.println("明文:"+plaintext);
        //密文：hex编码后的字符串
        String ciphertext = aesEncrypt(plaintext, strKey128);
        System.out.println("密文(hex编码):"+ciphertext);
       
       System.out.println("=======================AES解密开始==================");
       String plaintext2 = aesDecrypt(ciphertext, strKey128);
       System.out.println("解密明文:"+plaintext2);
    }
}
