...
//    private static ThreadLocal<Long> curNodeInstId = new ThreadLocal<Long>(){}
    ...
    protected String auditUserCodes;
    protected String auditUserNames;
    ...
    protected String auditUserRoleCode;// 加载审核人角色代码
    ...
    protected List<UserInfoMIP> auditUserList;// 加载审核人用户代码
     ...
     * 加载审核人(协办人员)
     */
    protected List<UserInfoMIP>  initAuditUsersConfig(GeneralModuleParam moduleParam) {
        List<UserInfoMIP> auditUserList = new ArrayList<UserInfoMIP>();
        if (moduleParam == null) {
            moduleParam = new GeneralModuleParam();
        }
        ...
        if ("T".equals(moduleParam.getHasXbUser())) {
            Set<String> users = SysUserFilterEngine.calcOperators(
                    ...
                    fUserDetail.getPrimaryUnit(), null, null, null,
                    fUserDetail.getUsercode(), null);
            List <String> userslist=generalUserWithUnitJson("auditUserList",  users);
    ...
    public List<UserInfoMIP> getAuditUserList() {
        return auditUserList;
    }

    public void setAuditUserList(List<UserInfoMIP> auditUserList) {
