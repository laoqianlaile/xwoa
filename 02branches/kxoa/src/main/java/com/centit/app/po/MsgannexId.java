...
public class MsgannexId implements java.io.Serializable {
	...
	/** full constructor */
	public MsgannexId(Long msgcode, String filecode) {
	...
	public boolean equals(Object other) {
		...
		ret = ret && ( this.getMsgcode() == castOther.getMsgcode() ||
					   (this.getMsgcode() != null && castOther.getMsgcode() != null
							   && this.getMsgcode().equals(castOther.getMsgcode())));
	...
	public int hashCode() {
		...
		result = 37 * result +
		 	(this.getMsgcode() == null ? 0 :this.getMsgcode().hashCode());
