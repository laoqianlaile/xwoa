...
public class OuterNetFileinfoFsAction  extends BaseEntityDwzAction<OuterNetFileinfoFs>  {
    ...
    public String toDownloadfile() {
        ...
        OuterNetFileinfoFs info = fileinfoFsManager.getObjectById(object.getFilecode());
	...
	private OuterNetFileinfoFs processUploadedFile(File file, String filename, String optCode, FUserDetail user) throws IOException {
