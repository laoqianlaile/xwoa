...
public class Publicinfo implements java.io.Serializable {
    ...
    private List<Publicinfo> childFiles;
    public List<Publicinfo> getChildFiles() {
        return childFiles;
    }

    public void setChildFiles(List<Publicinfo> childFiles) {
    ...
    /** full constructor */
    public Publicinfo(String infocode, String parentinfocode, FileinfoFs fileinfo,
    ...
    public void setFileinfoFs(FileinfoFs fileinfo) {
        this.fileinfoFs = fileinfo;
    }
