...
public class VPowerUserInfoId implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VPowerUserInfoId() {
    }

    /** full constructor */
    public VPowerUserInfoId(String usercode, String itemId) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof VPowerUserInfoId))
            return false;

        VPowerUserInfoId castOther = (VPowerUserInfoId) other;
        boolean ret = true;
