 ...
 private void saveModuleParam(){
    ...
    public String generalOptView() {
     ...
     // 查看办件业务数据信息
        String applyItemType =(String)request.getParameter("applyItemType");
        if(StringUtils.isNotBlank(applyItemType)){
            frameList.add(getBizYWViewFrame(object.getDjId(),applyItemType));
        }else{
            //查看办件基本数据信息
...
//        frameList.add(this.getAllViewFrame(object.getDjId()));
     ...
     * @return
     */
    public static OptHtmlFrameInfo getBizYWViewFrame(String djid,String moduleType) {
        ...
        viewFrameInfo
        .setFrameSrc("/oa/"+moduleType+"!view.do?djId=" + djid);
