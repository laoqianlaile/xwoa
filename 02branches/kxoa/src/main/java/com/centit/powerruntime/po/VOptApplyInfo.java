...
public class VOptApplyInfo implements java.io.Serializable {
    ...
    private Long flowInstId;//办理步骤，查看流程

    public VOptApplyInfo(String djId,  Date applyDate, String proposerName,
            ...
            Date checkDate, String checkMemo, Date bookDate,String bizstate,String usercode
            ) {
        super();
        this.djId = djId;
    ...
    // Constructors
    /** default constructor */
    public VOptApplyInfo() {
    }

    /** minimal constructor */
    public VOptApplyInfo(String djId) {
    ...
    public void copy(VOptApplyInfo other) {
    ...
    public void copyNotNullProperty(VOptApplyInfo other) {
