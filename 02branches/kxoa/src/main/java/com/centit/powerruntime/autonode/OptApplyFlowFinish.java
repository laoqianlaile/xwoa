...
public class OptApplyFlowFinish implements NodeEventSupport {
    ...
    private VProcTransUsersManager vprocTransUsersManager;
    ...
    public void runAfterCreate(FlowInstance flowInst, NodeInstance nodeInst,
        ...
        if ("car_sh".equals(procInfo.getNodeCode())||"car_ap".equals(procInfo.getNodeCode())) {
            if ("F".equals(procInfo.getIdeacode())) {
                OaCarApply oaCarApply = oaCarApplyManager.getObjectById(bean
                        .getDjId());
    ...
    public void setVprocTransUsersManager(
            VProcTransUsersManager vprocTransUsersManager) {
        this.vprocTransUsersManager = vprocTransUsersManager;
    }
