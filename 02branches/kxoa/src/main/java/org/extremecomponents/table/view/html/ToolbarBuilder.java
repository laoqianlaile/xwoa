...
/**
 * 修改pageJumpDroplist方法基于1.1.3版本源码
 * @since 1.1.3
...
public class ToolbarBuilder {
    ...
    public void pageJumpDroplist(){
        ...
        for(int i=1;i<=totalPage;i++){
            ...
            html.close();
            html.append("第 " + String.valueOf(i) + " 页");
            html.optionEnd();
        }
    }
    ...
    public void rowsDisplayedDroplist() {
        ...
        html.close();
        html.append("每页 " + String.valueOf(rowsDisplayed)+ " 条");
        html.optionEnd();
        ...
        html.close();
        html.append("每页 " +String.valueOf(medianRowsDisplayed)+ " 条");
        html.optionEnd();
        ...
        html.close();
        html.append("每页 " +String.valueOf(maxRowsDisplayed)+ " 条");
        html.optionEnd();
