...
public class RTXSvrApi {
    //服务器ip
    public static String RTXSER="127.0.0.1";
    //客户端与server传递的协议
   ...
   public int getServerPort(){
     ...
     * @return  drop (int 0:离线 1:在线 2:离开 11:不存在该用户 其它:未知状态)
     * @return 返回0 离线、1在线、2离开、-984用户不存在，其他表示调用失败
     */
     ...
     * @return int  0 操作成功 非0为失败
      */
    public int SetUserSimpleInfo(String UserName,String pwd)
    {
     ...
     * @return int  0 操作成功 非0为失败
      */
    public int SetUserSimpleInfo(String UserName,String email,String gender,String mobile,String phone,String pwd)
    {
